...
class _NewAppState extends State<NewApp> {
        ...
        return BlocBuilder<LanguageBloc, LanguageState>(
          ...
          return MaterialApp(
            ...
            builder: applicationState is ApplicationLoadSuccess
                ...
                : null,
            navigatorKey: _getNavigatorKey(applicationState),
          );
        });
      }),
    );
  ...
  GlobalKey<NavigatorState> _getNavigatorKey(ApplicationState state) {
    if (state is ApplicationLoadSuccess) {
      return locator<NavigationService>().navigatorKey;
    }
    return null;
  }
