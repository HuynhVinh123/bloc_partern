...
class TposApiService implements ITposApiService {
  ...
  Future<List<tpos_api_client.DistrictAddress>> getDistrictAddress(
  ...
  Future<List<tpos_api_client.WardAddress>> getWardAddress(
  ...
  @override
  Future<void> updateSaleOnlineOrder(
      tpos_api_client.SaleOnlineOrder order) async {
    Map jsonMap = order.toJson(true);
    jsonMap.removeWhere((key, value) {
      return value == null;
    });
  ...
  Future<tpos_api_client.SaleOnlineOrder> getOrderById(String orderId) async {
    ...
    if (response.statusCode == 200)
      return tpos_api_client.SaleOnlineOrder.fromJson(
...
//    paramMap["\$Expand"] = "Details";
  ...
  Future<List<tpos_api_client.ViewSaleOnlineOrder>>
      getViewSaleOnlineOrderWithFitter(
          {int take, int skip, OdataFilter filter, OdataSortItem sort}) async {
...
//    }..removeWhere((key, value) => value == null);
  ...
  @override
  Future<tpos_api_client.Partner> getDetailUserFacebook(
      String id, int teamId) async {
...
//      FileUtils.mkdir([dirloc]);
  ...
  @override
  Future<List<tpos_api_client.AccountPaymentTerm>>
      getAccountPaymentTerms() async {
