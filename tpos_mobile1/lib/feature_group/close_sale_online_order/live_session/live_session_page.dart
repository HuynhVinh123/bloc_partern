...
class _LiveSessionPageState extends State<LiveSessionPage> {
  ...
  Widget build(BuildContext context) {
    return BlocUiProvider<LiveSessionBloc>(
      bloc: _bloc,
      busyStates: [LiveSessionListLoaded],
      child: Scaffold(
        appBar: AppBar(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          SvgPicture.asset('assets/svg/livestream-session-blank.svg'),
          const Text(
...
class _ListSessionWidget extends StatelessWidget {
  const _ListSessionWidget({Key key, this.onAddPressed, this.items})
      : assert(items != null),
        super(key: key);
  final VoidCallback onAddPressed;
...
class _ListSessionItem extends StatelessWidget {
  const _ListSessionItem({Key key, @required this.item})
      : assert(item != null),
        super(key: key);
  static const double _boxBorderRadius = 8.0;
      ...
      builder: (context, vm, widget) {
        return Column(
          children: <Widget>[
              ...
              child: Row(
                children: <Widget>[
                  ...
                  BlinkWidget(
                    ...
                    children: <Widget>[
                      SvgPicture.asset(
                        'assets/icon/livestream-multicolor.svg',
                      ),
                      SvgPicture.asset(
                        'assets/icon/livestream-multicolor.svg',
                        color: Colors.grey,
            ...
            Row(
              children: <Widget>[
                SvgPicture.asset('assets/icon/ic_message.svg'),
                Padding(
                  padding: EdgeInsets.all(8.0),
                ...
                SvgPicture.asset('assets/icon/ic_share.svg'),
                Padding(
                  padding: EdgeInsets.all(8.0),
                ...
                SvgPicture.asset('assets/icon/ic_order.svg'),
                Padding(
                  padding: const EdgeInsets.all(8.0),
