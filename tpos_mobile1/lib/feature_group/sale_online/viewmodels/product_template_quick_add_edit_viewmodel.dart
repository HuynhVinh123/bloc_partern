...
class ProductTemplateQuickAddEditViewModel extends ViewModel
  ...
  ProductAttribute _productAttribute = ProductAttribute();
  ProductAttribute get productAttribute => _productAttribute;
  set productAttribute(ProductAttribute value) {
    _productAttribute = value;
    _productAttributeController.add(value);
  }

  List<ProductAttribute> _prdAttributes = [];
  List<ProductAttribute> _productAttributeValuess = [];
  List<ProductAttribute> get productAttributeValues => _productAttributeValuess;

  set productAttributeValuess(ProductAttribute value) {
  ...
  void deleteProductAttributeValue(ProductAttribute value) {
  ...
  void addAllAttributeValue(List<ProductAttribute> values) {
    _productAttributeValuess = List();
    _productAttributeValuess = values;
    _productAttributeValuesController.add(_productAttributeValuess);
  }

  void removeAttribute(ProductAttributeLine value) {
  ...
  void editBienThe() {
    ...
    productAttribute = ProductAttribute(name: null);
  }

  void addBienThe() async {
    List<ProductAttribute> lstAttb = List();
    lstAttb = _productAttributeValuess;

    ProductAttributeLine productAttributeLine = ProductAttributeLine();
  ...
  BehaviorSubject<List<ProductAttributeLine>> _productAttributeListController =
      new BehaviorSubject();
  Stream<List<ProductAttributeLine>> get productAttributeListStream =>
      _productAttributeListController.stream;

  BehaviorSubject<List<ProductAttribute>> _productAttributeValuesController =
      new BehaviorSubject();
  Stream<List<ProductAttribute>> get productAttributeValuesStream =>
      _productAttributeValuesController.stream;

  BehaviorSubject<ProductAttribute> _productAttributeController =
      new BehaviorSubject();
  Stream<ProductAttribute> get productAttributeStream =>
