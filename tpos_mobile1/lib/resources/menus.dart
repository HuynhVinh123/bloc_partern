...
HomeMenuConfig homeMenuAll() {
  return HomeMenuConfig(name: 'Menu tùy chỉnh', version: '1.0', mainMenus: [
    ...
    HomeMenuConfigGroup(
        ...
        menuGroupType: MenuGroupType.saleOnline,
        colorString: MenuGroupType.saleOnline.backgroundColor.value.toString(),
        children: [
          AppRoute.facebookSaleChannel,
    ...
    HomeMenuConfigGroup(
        ...
        menuGroupType: MenuGroupType.fastSaleOrder,
        colorString:
            MenuGroupType.fastSaleOrder.backgroundColor.value.toString(),
        children: [
          AppRoute.addFastSaleOrder,
          AppRoute.fastSaleOrders,
          AppRoute.deliveryOrder,
    ...
    HomeMenuConfigGroup(
        name: 'Điểm bán hàng',
        menuGroupType: MenuGroupType.posOrder,
        colorString: MenuGroupType.posOrder.backgroundColor.value.toString(),
        children: [
          AppRoute.posSale,
          AppRoute.posSession,
          AppRoute.posOrder,
    ...
    HomeMenuConfigGroup(
        name: 'Kho hàng',
        menuGroupType: MenuGroupType.inventory,
        colorString: MenuGroupType.inventory.backgroundColor.value.toString(),
        children: [
    ...
    HomeMenuConfigGroup(
        name: 'Danh mục',
        menuGroupType: MenuGroupType.category,
        colorString: MenuGroupType.category.backgroundColor.value.toString(),
        maxLine: 2,
        children: [
          AppRoute.customers,
          AppRoute.suppliers,
    ...
    HomeMenuConfigGroup(
        menuGroupType: MenuGroupType.setting,
        name: 'Cài đặt',
        colorString: MenuGroupType.setting.backgroundColor.value.toString(),
        children: [
          AppRoute.setting,
