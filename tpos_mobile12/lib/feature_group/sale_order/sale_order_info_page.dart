...
class SaleOrderInfoPage extends StatefulWidget {
  const SaleOrderInfoPage(this.saleOrder, {this.onEditCompleted,this.saleOrderId});
            ...
            appBar: AppBar(
              ...
              actions: <Widget>[
                if (viewModel.saleOrder.state == "draft" ||
                  ...
                  Visibility(
                    visible: widget.saleOrderId == null,
...
/*              if (viewModel.createInvoiceCommand.isEnable) ...[
  ...
  void initState() {
    ...
    viewModel.initCommand(saleOrderId: widget.saleOrderId);
