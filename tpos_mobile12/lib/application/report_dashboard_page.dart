...
class ReportDashboardPageState extends State<ReportDashboardPage>
  ...
  Widget _buildSaleResultReportPanel() {
    return _myCusContainer(
      myPaddingLeft: paddingLeft,myPaddingRight: paddingRight,
...
//                              ),
  ...
  Widget _myCusContainer({Widget child,double myPaddingLeft,double myPaddingRight}) {
    return Padding(
  ...
  Widget _buildLineChart() {
    return _myCusContainer(child: LineChartPage(scaffoldKey: _scaffoldKey),myPaddingRight: paddingRight,myPaddingLeft: paddingLeft);
  }

  Widget _buildPieChart() {
    return _myCusContainer(child: PieChartPage(scaffoldKey: _scaffoldKey,),myPaddingLeft: paddingRight,myPaddingRight: paddingLeft);
  }

  Widget _buildColumnChart() {
    return _myCusContainer(child: ColumnChartPage(scaffoldKey: _scaffoldKey),myPaddingRight: paddingRight,myPaddingLeft: paddingLeft);
  }
