...
import 'package:tpos_mobile/feature_group/sale_online/ui/report_order_detail_invoice_list_page.dart';
...
class ReportOrderDetailPage extends StatefulWidget {
  const ReportOrderDetailPage({this.bloc, this.filterBloc, this.scaffoldKey,this.filter});
              ...
              child: Center(
                child: Text(
                  state.reportOrderDetails != null
                      ? state.reportOrderDetails.length.toString()
                      : "0",
