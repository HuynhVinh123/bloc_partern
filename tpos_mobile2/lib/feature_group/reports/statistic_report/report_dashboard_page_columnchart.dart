...
//    _verticalBarChartOptions.valueToLabel(123123);
//    _verticalBarChartOptions = chart.ChartOptions();
//    _verticalBarChartOptions.useUserProvidedYLabels = true;

    // _chartData = chart.ChartData();
    _chartData = chart.RandomChartData(
        useUserProvidedYLabels: chart.LineChartOptions().useUserProvidedYLabels);
      ...
      child: AspectRatio(
        ...
        child: chart.VerticalBarChart(
          ...
          container: chart.VerticalBarChartContainer(
            ...
            xContainerLabelLayoutStrategy:  chart.DefaultIterativeLabelLayoutStrategy(
