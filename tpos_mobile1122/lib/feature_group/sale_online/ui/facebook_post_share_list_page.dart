                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      Flexible(
                        // flex: null,
                        child: _itemShare(
                            S.current.fbPostShare_SharePersonally,
                            _vm.postCount.toString(),
                      ...
                      Flexible(
                        child: _itemShare(
                            S.current.fbPostShare_ShareToGroup,
                            _vm.groupCount.toString(),
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Text(
                      "${index + 1}",
                      style: TextStyle(
                          color: _getTextIndexColor(index + 1), fontSize: 11),
                    ),
                  ),
                ),
              )
