...
class _SupplierReportPageState extends State<SupplierReportPage> {
  var _viewModel = locator<SupplierReportViewModel>();
    ...
    return ViewBase<SupplierReportViewModel>(
        ...
        builder: (context, model, sizingInformation) {
          return Scaffold(
              ...
              appBar: AppBar(
                title: Text("Công nợ nhà cung cấp"),
              ...
              child: Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Visibility(
                      visible: _viewModel.companyOfUser == null ? false : true,
                      child: Container(
                        width: 45,
                        height: 45,
                        child: InkWell(
              ...
              child: Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Visibility(
                      visible: _viewModel.supplier != null ? true : false,
                      child: Container(
                        width: 45,
                        height: 45,
                        child: InkWell(
