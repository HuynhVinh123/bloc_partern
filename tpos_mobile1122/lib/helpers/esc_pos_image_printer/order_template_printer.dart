...
class OrderTemplatePrinter {
  Future<void> templateShip(CanvasPrinter printer, PrintShipData data) async {
    var setting = locator<ISettingService>();
    ...
    final double fontSize = 25 * setting.shipFontScale.getScale();
    final double fontSize1 = 30 * setting.shipFontScale.getScale();
    final double headerFontSize = 40 * setting.shipFontScale.getScale();
    ...
    if (data.note != null) {
      printer.emptyLines(10);
      printer.printTextLn("Lưu ý: ${data.note}", style: style);
    }
  ...
  Future<void> templateFastSaleOrder(
    ...
    final double fontSize = 25 * setting.fastSaleOrderFontScale.getScale();
    final double headerFontSize =
        40 * setting.fastSaleOrderFontScale.getScale();
    final CanvasStyles style = CanvasStyles(fontSize: fontSize);
