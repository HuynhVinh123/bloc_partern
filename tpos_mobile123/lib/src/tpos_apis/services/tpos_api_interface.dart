...
abstract class ITposApiService {
  ...
  Future<tpos_api.SaleOnlineOrder> getOrderById(String orderId);
  ...
  Future<List<tpos_api.SaleOnlineOrder>> getOrdersByFacebookPostId(
      String postId);
  Future<int> getProductQuantityByPostId(String postId);

  /// Tạo đơn hàng từ app
  Future<tpos_api.SaleOnlineOrder> insertSaleOnlineOrderFromApp(
      tpos_api.SaleOnlineOrder order,
      {int timeoutSecond});

  /// Sửa đơn hàng từ app
  Future<void> updateSaleOnlineOrder(tpos_api.SaleOnlineOrder order);
  ...
  Future<List<tpos_api.SaleOnlineOrder>> getSaleOnlineOrders(
      {int take,
      int skip,
      int partnerId,
  ...
  Future<List<tpos_api.SaleOnlineOrder>> getSaleOnlineOrdersFilter(
      {int take, int skip, OdataFilter filter, OdataSortItem sort});

  /// Lấy danh sách đơn hàng online view
  Future<List<tpos_api.ViewSaleOnlineOrder>> getViewSaleOnlineOrderWithFitter(
      {int take, int skip, OdataFilter filter, OdataSortItem sort});
  ...
  Future<List<tpos_api_client.AccountPaymentTerm>> getAccountPayments();
  ...
  Future<List<tpos_api.CRMTeam>> getSaleChannelList();

  /// Kiểm tra địa chỉ nhanh
  Future<List<CheckAddress>> checkAddress(String text);

  /// Sửa kênh bán hàng facebook
  Future<bool> editSaleChannelById({tpos_api.CRMTeam crmTeam});

  /// Thêm kênh bán hàng facebook
  Future<bool> addSaleChannel({tpos_api.CRMTeam crmTeam});
  ...
  Future<OdataResult<List<tpos_api.ApplicationUser>>>
      getApplicationUsersSaleOrder(String keyword);
  ...
  Future<List<tpos_api_client.WardAddress>> getWardAddress(String districtCode);

  /// Hàm lấy Danh sách District
  Future<List<tpos_api_client.DistrictAddress>> getDistrictAddress(String cityCode);

  /// Lấy danh sách thành phố
  Future<List<tpos_api_client.CityAddress>> getCityAddress();
...
/* ASHIP API*/
  ...
  // Lấy danh sách người dùng
  Future<tpos_api.Partner> getDetailUserFacebook(String id, int teamId);
  ...
  Future<List<tpos_api.SaleOnlineOrder>> getOrderSaleOnline(
      {String userId, String postId});
  ...
  Future<List<tpos_api_client.AccountPaymentTerm>> getAccountPaymentTerms();
