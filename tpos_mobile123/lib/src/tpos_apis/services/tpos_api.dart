...
class TposApiService implements ITposApiService {
  ...
  Future<List<tpos_api_client.CityAddress>> getCityAddress() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        results = cityAddress.map((map) {
          return tpos_api_client.CityAddress.fromMap(map);
        }).toList();
      } else {
        print("Response status: ${response.statusCode}");
      }
  ...
  Future<List<tpos_api_client.DistrictAddress>> getDistrictAddress(String cityCode) async {
    var data = {
      "data": {"code": cityCode},
      "provider": "Undefined"
    };
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        results = districtAddress.map((map) {
          return tpos_api_client.DistrictAddress.fromMap(map);
        }).toList();
      } else {
        print("Response status: ${response.statusCode}");
      }
  ...
  Future<List<tpos_api_client.WardAddress>> getWardAddress(String districtCode) async {
    var results;
    var data = {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        results = wardAddress.map((map) {
          return tpos_api_client.WardAddress.fromMap(map);
        }).toList();
      } else {
        print("Response status: ${response.statusCode}");
      }
  ...
  @override
  Future<List<tpos_api_client.SaleOnlineOrder>> getOrdersByFacebookPostId(
      String postId) async {
    var response = await _tposClient.httpGet(
    ...
    if (response.statusCode == 200) {
      ...
      return (jsonMap["value"] as List).map((map) {
        return tpos_api_client.SaleOnlineOrder.fromJson(map);
      }).toList();
    }
    throwTposApiException(response);
    return null;
  ...
  @override
  Future<tpos_api_client.SaleOnlineOrder> insertSaleOnlineOrderFromApp(
      tpos_api_client.SaleOnlineOrder order,
    ...
    if (response.statusCode == 200) {
      ...
      return tpos_api_client.SaleOnlineOrder.fromJson(resultJonMap);
    }
    throwTposApiException(response);
    return null;
  }
  ...
  @override
  Future<void> updateSaleOnlineOrder(tpos_api_client.SaleOnlineOrder order) async {
    Map jsonMap = order.toJson(true);
    jsonMap.removeWhere((key, value) {
      return value == null;
    });
  ...
  Future<List<SavedFacebookPost>> getSavedFacebookPost(
    ...
    if (response.statusCode == 200) {
      Map returnJsonMap = jsonDecode(response.body);
  ...
  Future<List<SaleOrderLine>> getSaleOrderInfo(int id) async {
    var response = await _tposClient
  ...
  Future<tpos_api_client.SaleOnlineOrder> getOrderById(String orderId) async {
    var response = await _tposClient.httpGet(
        path: "/odata/SaleOnline_Order($orderId)",
        param: {"\$expand": "Details, Partner"});
    if (response.statusCode == 200)
      return tpos_api_client.SaleOnlineOrder.fromJson(jsonDecode(response.body));
    throwTposApiException(response);
    return null;
  }
  ...
  Future<List<CompanyOfUser>> getCompanyOfUser() async {
    var response = await _tposClient.httpGet(path: "/Json/GetCompanyOfUser");
    if (response.statusCode == 200) {
      var jsonMap = jsonDecode(response.body);
  ...
  Future<List<UserReportStaff>> getUserReportStaff() async {
    var response = await _tposClient.httpGet(path: "/ReportStaff/GetUser");
    if (response.statusCode == 200) {
      var jsonMap = jsonDecode(response.body);
      return (jsonMap as List).map((map) {
  ...
  @override
  Future<List<tpos_api_client.SaleOnlineOrder>> getSaleOnlineOrders(
      {int take,
      int skip,
      int partnerId,
...
//      "\$orderby": orderBy,
    ...
    if (response.statusCode == 200) {
      return (jsonDecode(response.body)["value"] as List)
          .map((f) => tpos_api_client.SaleOnlineOrder.fromJson(f))
          .toList();
    }
    throwHttpException(response);
    return null;
  ...
  @override
  Future<List<tpos_api_client.SaleOnlineOrder>> getSaleOnlineOrdersFilter(
...
//    paramMap["\$Expand"] = "Details";
  ...
  Future<List<tpos_api_client.ViewSaleOnlineOrder>> getViewSaleOnlineOrderWithFitter(
      {int take, int skip, OdataFilter filter, OdataSortItem sort}) async {
  ...
  static List<tpos_api_client.SaleOnlineOrder> _getOrder(String json) {
  ...
  static List<tpos_api_client.ViewSaleOnlineOrder> _getViewOrder(String json) {
    var jsonMap = jsonDecode(json);
    return (jsonMap["value"] as List).map(
      (map) {
        return tpos_api_client.ViewSaleOnlineOrder.fromJson(map);
      },
    ).toList();
  }
  ...
  Future<FastSaleOrderAddEditData> getFastSaleOrderForEdit(int id) async {
    var response = await _tposClient.httpGet(path: "/odata/FastSaleOrder($id)");
    if (response.statusCode == 200)
      return FastSaleOrderAddEditData.fromJson(jsonDecode(response.body));
    throwTposApiException(response);
    return null;
  ...
  @override
  Future<List<tpos_api_client.AccountPaymentTerm>> getAccountPayments() async {
    var response =
    ...
    if (response.statusCode == 200) {
      var jsonMap = jsonDecode(response.body);
      return (jsonMap["value"] as List).map((map) {
        return tpos_api_client.AccountPaymentTerm.fromJson(map);
      }).toList();
    }
    throwTposApiException(response);
    return null;
  ...
  @override
  Future<List<tpos_api_client.CRMTeam>> getSaleChannelList() async {
    var response = await _tposClient.httpGet(path: "/odata/CRMTeam");

    return (getHttpResult(response)["value"] as List)
        .map((f) => tpos_api_client.CRMTeam.fromJson(f))
        .toList();
  }
  ...
  @override
  Future<bool> editSaleChannelById({tpos_api_client.CRMTeam crmTeam}) async {
  ...
  @override
  Future<bool> addSaleChannel({tpos_api_client.CRMTeam crmTeam}) async {
    var jsonMap = crmTeam.toJson();
    jsonMap.removeWhere((key, value) {
      return value == null;
    });
  ...
  Future<void> deletePartner(int id) async {
    assert(id != null);
    var response = await _tposClient.httpDelete(path: "/odata/Partner($id)");
    if (response.statusCode == 204) {
      return null;
    }
    throwTposApiException(response);
  ...
  Future<TPosApiResult<bool>> deleteProductCategory(int id) async {
    assert(id != null);
    var response = await _tposClient.httpDelete(
  ...
  @override
  Future<OdataResult<List<tpos_api_client.ApplicationUser>>>
      getApplicationUsersSaleOrder(String keyword) async {
    var response = await _tposClient.httpGet(
    ...
    return OdataResult.fromJson(json, parseValue: () {
      return (json["value"] as List)
          .map((f) => tpos_api_client.ApplicationUser.fromJson(f))
          .toList();
    });
  }
...
//    }..removeWhere((key, value) => value == null);
  ...
  Future<List<TPosCity>> getTposCity() async {
    var response = await http.get("https://tpos.vn/api/City");
    if (response.statusCode == 200) {
      return (jsonDecode(response.body) as List)
  ...
  Future<TPosApiResult<bool>> deletePosOrder(int id) async {
    assert(id != null);
    var response = await _tposClient.httpDelete(path: "/odata/POS_Order($id)");
    if (response.statusCode.toString().startsWith("2")) {
      return new TPosApiResult(error: false, result: true);
    } else {
      var json = jsonDecode(response.body);
  ...
  Future<MailTemplate> getMailTemplateById(int id) async {
    var response = await _tposClient.httpGet(path: "/odata/MailTemplate($id)");
  ...
  Future<List<StatusExtra>> getStatusExtra() async {
    var repsonse = await _tposClient.httpGet(
  ...
  Future<PrinterConfig> getPrintInvoiceConfig() async {
    var shipConfig = await this.getPrinterConfigs();
  ...
  Future<List<PartnerReport>> getPartnerReports(
    ...
    if (response.statusCode == 200) {
      ...
      for (var partnerReport in _partnerReports) {
  ...
  @override
  Future<tpos_api_client.Partner> getDetailUserFacebook(String id, int teamId) async {
    List<tpos_api_client.Partner> _partners = [];
    var response = await _tposClient.httpGet(
        path:
    ...
    if (response.statusCode == 200) {
      ...
      _partners = (mapData["value"] as List)
          .map((value) => tpos_api_client.Partner.fromJson(value))
          .toList();
  ...
  @override
  Future<List<tpos_api_client.SaleOnlineOrder>> getOrderSaleOnline(
      {String userId, String postId}) async {
    List<tpos_api_client.SaleOnlineOrder> saleOrders = [];
    var response = await _tposClient.httpGet(
        path:
    ...
    if (response.statusCode == 200) {
      ...
      saleOrders = (mapData["value"] as List)
          .map((value) => tpos_api_client.SaleOnlineOrder.fromJson(value))
          .toList();
      return saleOrders;
    }
    throwHttpException(response);
...
//      FileUtils.mkdir([dirloc]);
  ...
  @override
  Future<List<tpos_api_client.AccountPaymentTerm>> getAccountPaymentTerms() async {
    List<tpos_api_client.AccountPaymentTerm> accountPaymentTerms = [];
    var response = await _tposClient.httpGet(
        path: "/odata/AccountPaymentTerm?%24format=json&%24count=true");
    if (response.statusCode == 200) {
      var mapData = json.decode(response.body);
      accountPaymentTerms = (mapData["value"] as List)
          .map((value) => tpos_api_client.AccountPaymentTerm.fromJson(value))
          .toList();
