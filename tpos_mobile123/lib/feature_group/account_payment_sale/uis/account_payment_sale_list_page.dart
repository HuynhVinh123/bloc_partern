    ...
    return Dismissible(
      ...
      confirmDismiss: (direction) async {
        final dialogResult = await showQuestion(
            ...
            message: "${S.current.paymentReceipt_doYouWantToDeletePaymentReceipt} ${item.name ?? ""}");
                          ...
                          children: <Widget>[
                            ...
                            Row(
                              children: <Widget>[
                                ...
                                Text(
                                  item.state == "draft" ? S.current.draft : S.current.hasEnteredTheBook,
                                  textAlign: TextAlign.left,
                                  style: TextStyle(
                                    color: item.state == "draft"
                                        ? Colors.grey[600]
