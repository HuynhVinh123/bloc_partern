        ...
        builder: (context, model, sizingInformation) {
          return WillPopScope(
              ...
              child: Scaffold(
                appBar: AppBar(
                  /// Thông tin phiếu chi
                  title:  Text(S.current.paymentReceipt_paymentReceiptInformation),
                  actions: <Widget>[
                    IconButton(
                ...
                child: FlatButton(
                  ...
                  onPressed: () async {
                    final dialogResult = await showQuestion(
                        ...
                        message: S.current.paymentReceipt_doYouWantToAddToTheBook);
    ...
    return Column(
      children: <Widget>[
        ...
        InfoRow(
          ...
          content: Text(item.state == "draft" ? S.current.draft : S.current.hasEnteredTheBook,
              textAlign: TextAlign.right, style: detailFontStyle),
        ),
      ],
    );
