...
class FastSaleOrderAddEditFullViewModel extends ViewModel {
  FastSaleOrderAddEditFullViewModel(
      ...
      tpos_api_client.PartnerApi partnerApi,
    ...
    _partnerApi = partnerApi ?? GetIt.I<tpos_api_client.PartnerApi>();
    ...
    _remoteConfig = remoteConfigService ?? locator<RemoteConfigService>();
  ...
  tpos_api_client.PartnerApi _partnerApi;
  ...
  /// Danh sách bảng giá
  List<tpos_api_client.ProductPrice> _priceLists;
  ...
  tpos_api_client.Partner _partner;
  ...
  /// Bảng giá
  tpos_api_client.ProductPrice _productPrice;
  ...
  /// Nhân viên bán
  tpos_api_client.ApplicationUser _saleUser;

  /// Công ty bán
  tpos_api_client.Company _company;
  ...
  List<tpos_api_client.ProductPrice> get priceLists => _priceLists;
  ...
  tpos_api_client.Partner get partner => _partner;
  tpos_api_client.ApplicationUser get user => _saleUser;

  AccountJournal get paymentJournal => _paymentJournal;
  StockWareHouse get wareHouse => _wareHouse;
  tpos_api_client.Company get company => _company;
  Journal get journal => _journal;
  tpos_api_client.ProductPrice get priceList => _productPrice;
...
//      }
  ...
  set priceList(tpos_api_client.ProductPrice priceList) {
  ...
  * */
  ...
  Future<void> _loadPriceList() async {
    _priceLists = await _priceListApi.getPriceListAvaible(DateTime.now());
    notifyListeners();
  }
  ...
  Future<void> selectPartnerCommand(tpos_api_client.Partner partner,
      [int partnerId]) async {
  ...
  Future<void> selectShipReceiverCityCommand(
      tpos_api_client.CityAddress city) async {
    shipReceiver?.city = city;
    onPropertyChanged("");
  }

  Future<void> selectShipReceiverDistrictCommand(
      tpos_api_client.DistrictAddress district) async {
    shipReceiver?.district = district;
    onPropertyChanged("");
  }

  Future<void> selectShipReceiverWardCommand(
      tpos_api_client.WardAddress ward) async {
  ...
  void _calculateTotalWeight({bool notify = true}) {
    final double totalWeight = _orderLines.sumByDouble((e) => e.weight);
