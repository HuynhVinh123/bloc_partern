          ...
          return WillPopScope(
            onWillPop: () async {
              ...
              return await confirmClosePage(context,
                  title: "Xác nhận đóng",
                  message: "Thoát tính năng điểm bán hàng?");
            },
            child: Scaffold(
              appBar: _buildAppBar(),
              body: SafeArea(
            ...
            if (_vm.lstLine.isNotEmpty) {
              if (_vm.positionCart != "-1") {
                final dialogResult = await showQuestion(
                    ...
                    title: "Xác nhận xóa",
                    message:
                        "Nếu bạn xóa tất cả sản phẩm sẽ trong giỏ sẽ mất!");
      ...
      child: Center(
        child: FlatButton(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text(
                "Giỏ: ${_vm.childCarts[index].position}",
                style: TextStyle(
                    color: _vm.childCarts[index].check == 0
                        ? Colors.grey
                              ...
                              Visibility(
                                ...
                                child: Row(
                                  children: <Widget>[
                                    ...
                                    Expanded(
                                      child: Text(
                                        "Chiết khấu ${vietnameseCurrencyFormat(item.discount)}%",
                                        style: const TextStyle(
