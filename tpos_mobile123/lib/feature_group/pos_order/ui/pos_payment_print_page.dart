                          ...
                          buildItem(
                              _viewModel.discountMethod == 0
                                  ...
                                  : Icon(Icons.monochrome_photos,
                                      color: const Color(0xFF28A745)),
                              _viewModel.discountMethod == 0
                                  ? "Chiết khấu (${vietnameseCurrencyFormat(_viewModel.discount)}%)"
                                  : "Giảm tiền",
                              vietnameseCurrencyFormat(
                                  _viewModel.discountMethod == 0
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Align(
                        ...
                        child: Text(
                          "Tiền thừa: ${vietnameseCurrencyFormat(_viewModel.multiPayments[index].amountReturn)}",
                          style: const TextStyle(
          ...
          Column(
            ...
            children: <Widget>[
              ...
              const Text(
                ...
                style: TextStyle(fontSize: 14, color: Color(0xFF9CA2AA)),
              )
            ],
          )
        ],
                ...
                child: FlatButton(
                    onPressed: () {
                      if (widget.numProduct == 0) {
                        _viewModel.showNotifyPayment("Giỏ hàng của bạn trống!");
                      } else {
