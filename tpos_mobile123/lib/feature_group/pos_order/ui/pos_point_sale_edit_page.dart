        ...
        builder: (context, model, _) {
          return WillPopScope(
            ...
            child: Scaffold(
              ...
              appBar: AppBar(
                title: const Text("Sửa thông tin điểm bán hàng"),
              ),
              body: Material(
                color: Colors.white,
      ...
      child: SingleChildScrollView(
        child: Column(
            ...
            children: <Widget>[
              ...
              Row(
                children: <Widget>[
                  Expanded(flex: 2, child: _header("Tên điểm bán hàng")),
              ...
              Row(
                children: <Widget>[
                  Expanded(flex: 2, child: _header("Loại hoạt động")),
              ...
              Row(
                children: <Widget>[
                  Expanded(flex: 2, child: _header("Địa điểm kho")),
              ...
              Row(
                children: <Widget>[
                  Expanded(flex: 2, child: _header("Bảng giá")),
              ...
              _spaceHeight,
              _header("Phương thức thanh toán khả dụng"),
              _spaceHeight,
    ...
    return ExpansionTile(
        ...
        children: _vm.cashMoneys.keys.map((String key) {
          return Card(
            ...
            child: CheckboxListTile(
              activeColor: Colors.green,
              title: const Text("Kiểm soát tiền mặt"),
        ...
        Card(
          ...
          child: Column(
            children: <Widget>[
              CheckboxListTile(
                activeColor: Colors.green,
                title: const Text("Thêm thông điệp vào đầu chân trang"),
    ...
    return ExpansionTile(
      ...
      children: <Widget>[
              ...
              Visibility(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      const Expanded(
                        flex: 2,
                        child: Text("Chiết khấu mặc định (%)"),
                      ),
        ...
        Card(
          ...
          child: CheckboxListTile(
            activeColor: Colors.green,
            title: const Text("Cho phép giảm tiền trên toàn bộ đơn hàng"),
        ...
        Card(
          ...
          child: Column(
            children: <Widget>[
              CheckboxListTile(
                activeColor: Colors.green,
                title: const Text("Áp dụng thuế trên toàn bộ đơn hàng"),
                value: _vm.ifaceTax,
                onChanged: (bool value) {
                  setState(() {
                    _vm.ifaceTax = value;
        ...
        child: Container(
          ...
          child: Row(
            children: <Widget>[
              Expanded(
                  child: Text(
                " ${_vm.prices == null ? "Chọn bảng giá" : _vm.prices.name}",
                textAlign: TextAlign.right,
              )),
              Visibility(
        ...
        child: Container(
          ...
          child: Row(
            children: <Widget>[
              Expanded(
                  child:
                      Text(" ${_vm.tax == null ? "Chọn thuế" : _vm.tax.name}")),
              Visibility(
