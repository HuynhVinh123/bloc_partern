            ...
            onPressed: () {
              showDialog(
                  ...
                  builder: (ctxt) {
                    ...
                    return AlertDialog(
                      title: const Text("Nhập ID Live video"),
                      content: TextField(
                                  ...
                                  child: ListTile(
                                    ...
                                    title: Column(
                                      ...
                                      children: <Widget>[
                                        ...
                                        if (viewModel.facebookPosts[index]
                                                    .liveCampaignName !=
                                                null &&
                                          ...
                                          SizedBox(
                                            child: Card(
                                              ...
                                              child: Padding(
                                                ...
                                                child: Text(
                                                  "${S.current.liveCampaign}: ${viewModel.facebookPosts[index].liveCampaignName}",
                                                  style: const TextStyle(
                                                      color: Colors.white),
                                                ),
                                              ),
...
//                  },
                ...
                ListTile(
                  ...
                  title: const Text("Mở trên trình duyệt"),
                  onTap: () async {
                ...
                ListTile(
                  ...
                  title: const Text("Lưu bình luận"),
                  onTap: () async {
                    Navigator.pop(context);
