...
import 'package:tpos_mobile/feature_group/sale_online/viewmodels/partner_info_viewmodel.dart';
  ...
  Future<void> _handleEdit() async {
    await Navigator.push(
      ...
      MaterialPageRoute(builder: (context) {
        final PartnerAddEditPage partnerAddEditPage = PartnerAddEditPage(
