...
class ReportOrderBloc extends Bloc<ReportOrderEvent, ReportOrderState> {
  ...
  Stream<ReportOrderState> _getReportSaleGeneral(
    ...
    try {
      ...
      yield ReportOrderLoadFailure(title: S.current.notification, content: e.toString());
    }
  }
    ...
    try {
      ...
      final ReportOrderDetailOverview _reportOrderDetailOverview =
          await _apiClient.getReportOrderDetail(
              ...
              partnerId: _isFilterByPartner ? _partner.id : null,
              staffId: _isFilterByStaff ? _userReportStaffOrder.value : null);
      List<ReportOrderDetail> _reportOrderDetails=_reportOrderDetailOverview.reportOrderDetails;
      ...
      yield ReportOrderDetailLoadSuccess(
          ...
          sumReportGeneral: _sumReportGeneral,countInvoies: _reportOrderDetailOverview.odataCount);
    } catch (e, s) {
      yield ReportOrderLoadFailure(title: S.current.notification, content: e.toString());
    }
  }
  ...
  Stream<ReportOrderState> _getReportOrderDetailLoadMore(
    ...
    try {
      ...
      ReportOrderDetailOverview _reportOrderDetailOverviewLoadMore =
          await _apiClient.getReportOrderDetail(
              top: event.limit,
              skip: event.skip,
              dateFrom: _dateFrom,
              ...
              partnerId: _isFilterByPartner ? _partner.id : null,
              staffId: _isFilterByStaff ? _userReportStaffOrder.value : null);
      final List<ReportOrderDetail> _reportOrderDetailMores =_reportOrderDetailOverviewLoadMore.reportOrderDetails;
      ...
      yield ReportOrderDetailLoadSuccess(
          ...
          sumReportGeneral: event.sumReportGeneral,countInvoies: _reportOrderDetailOverviewLoadMore.odataCount);
    } catch (e, s) {
      yield ReportOrderLoadFailure(title:S.current.notification, content: e.toString());
    }
  }
  ...
  Stream<ReportOrderState> _getReportOrderDetailLoadFromLocalMore(
    ...
    yield ReportOrderDetailLoadSuccess(
        reportOrderDetails: event.reportOrderDetails,
        sumReportOrderDetail: event.sumReportOrderDetail,
        sumReportGeneral: event.sumReportGeneral,countInvoies: event.countInvoices);
  }
