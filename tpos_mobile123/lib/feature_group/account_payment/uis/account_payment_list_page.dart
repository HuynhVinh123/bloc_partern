        ...
        builder: (context, model, sizingInformation) {
          return Scaffold(
            ...
            appBar: AppBar(
              title: _vm.isSearch
                  ? _buildSearch()
                  : const Text('Danh sách phiếu thu'),
              actions: <Widget>[
                IconButton(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          AppFilterPanel(
            ...
            title: const Text("Lọc theo loại phiếu thu"),
            children: <Widget>[
              Container(
                height: 45,
    ...
    return Dismissible(
        ...
        confirmDismiss: (direction) async {
          final dialogResult = await showQuestion(
              context: context,
              title: "Xác nhận xóa",
              message: "Bạn có muốn xóa phiếu thu ${item.name ?? ""}");
          if (dialogResult == DialogResultType.YES) {
            if (item.state == "posted") {
              _vm.showError("Bạn không thể xóa thanh tóa đã được thêm vào sổ");
              return false;
            }
                            ...
                            children: <Widget>[
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Expanded(
                                    child: Text(
                                      " ${item.senderReceiver ?? "< Chưa có người nộp >"}",
                                      style:
