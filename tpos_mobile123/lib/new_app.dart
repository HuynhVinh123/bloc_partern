...
import 'feature_group/sale_online/ui/partner_category_page.dart';
...
import 'widgets/dialog_provider.dart';
...
class _NewAppState extends State<NewApp> {
      ...
      child: BlocConsumer<ApplicationBloc, ApplicationState>(
        ...
        return BlocBuilder<LanguageBloc, LanguageState>(
          ...
          return MaterialApp(
            ...
            home: _getInitHome(applicationState),
            ...
            navigatorObservers: applicationState is ApplicationLoadSuccess
                ? <NavigatorObserver>[
                    locator<AnalyticsService>().getAnalyticsObserver(),
                  ]
                : [],
            builder: applicationState is ApplicationLoadSuccess
                ...
                : null,
            navigatorKey: applicationState is ApplicationLoadSuccess
  ...
  Widget _getInitHome(ApplicationState state) {
  ...
  Map<String, WidgetBuilder> _buildRoute() => {
        ...
        // Report
        AppRoute.inventoryReport: (context) => StockReportPage(),
        ...
        AppRoute.addOrder: (context) => SaleOrderAddEditPage(
              isCopy: true,
            ),
