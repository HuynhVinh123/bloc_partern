...
import '../models/entities/sale_order_report/report_order_detail.dart';
...
abstract class AlertApi {
  ...
  Future<List<OrderFinancial>> getOrderFinancial({int limit,int skip,String overViewValue});

  Future<List<OrderFinancial>> getOrderFinancialRefund({int limit,int skip,String overViewValue});
}
