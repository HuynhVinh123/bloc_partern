...
class S {
  ...
  /// Partner
  String get reportOrder_Partner {
    return Intl.message(
      'Partner',
      name: 'reportOrder_Partner',
      desc: '',
      args: [],
    );
  }
  /// Employee
  String get reportOrder_Employee {
    return Intl.message(
      'Employee',
      name: 'reportOrder_Employee',
      desc: '',
      args: [],
    );
  }
  /// Company
  String get reportOrder_Company {
    return Intl.message(
      'Company',
      name: 'reportOrder_Company',
      desc: '',
      args: [],
    );
  }
 ...
 /// The control was not successful đối soát không thành công
