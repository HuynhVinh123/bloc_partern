...
class TypeAccountSaleListViewModel extends ViewModelBase {
  ...
  Future<void> getAccounts() async {
    ...
    _currentPage = 0;
    try {
      final result = await _tposApi.getTypeAccountAccountSales(
          page: _currentPage,
          pageSize: limit,
          skip: skip,
          take: limit,
  ...
  Future<List<Account>> loadMoreAccounts() async {
    ...
    try {
      skip += limit;
      result = await _tposApi.getTypeAccountAccountSales(
          page: _currentPage,
          pageSize: limit,
          skip: skip,
          take: limit,
  ...
  Future<bool> deleteAccount(int id, Account account) async {
    try {
      final bool result = await _tposApi.deleteTypeAccountAccountSale(id);
      if (result) {
