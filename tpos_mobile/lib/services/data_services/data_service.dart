...
/// Một [DataService] sẽ được đăng ký Singleton. Mục đích làm trung gian thông báo thay đổi dữ liệu của các [DataModel] cho các đối tượng khác lắng nghe
...
class DataService {
  ...
  final PublishSubject<DataMessage> _dataSubject =
