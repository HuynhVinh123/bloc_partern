...
class RemoteConfigService {
  ...
  Future<void> init() async {
    ...
    _remoteConfig.setDefaults(<String, dynamic>{
      ...
      "facebook_option":
          '{"permissions":["email public_profile user_posts user_videos pages_show_list manage_pages publish_pages pages_messaging groups_access_member_info pages_messaging pages_messaging_subscriptions"],"enable_fetch_duration_user":true}',
