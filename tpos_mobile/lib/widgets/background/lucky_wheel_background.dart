...
class LuckyWheelBackground extends StatefulWidget {
  const LuckyWheelBackground(
      {Key key,
  ...
  @override
  _LuckyWheelBackgroundState createState() => _LuckyWheelBackgroundState();
...
class _LuckyWheelBackgroundState extends State<LuckyWheelBackground> with SingleTickerProviderStateMixin {
...
class _BackgroundPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Rect rect = Rect.fromCenter(center: Offset(centerX, centerY), width: size.width, height: size.width);
