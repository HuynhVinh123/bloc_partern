...
class CustomInputDecorator extends StatefulWidget {
...
class _InputDecoratorState extends State<CustomInputDecorator> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(CustomInputDecorator old) {
    super.didUpdateWidget(old);
