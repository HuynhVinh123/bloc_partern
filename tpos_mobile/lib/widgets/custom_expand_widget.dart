...
class CustomExpandWidget extends StatefulWidget {
  ...
  @override
  CustomExpandWidgetState createState() => CustomExpandWidgetState();
}

class CustomExpandWidgetState extends State<CustomExpandWidget> with SingleTickerProviderStateMixin {
  AnimationController _controller;
  Animation<double> _heightFactor;
  bool _expand = false;

  @override
  void didUpdateWidget(CustomExpandWidget oldWidget) {
    if (widget.update) {
