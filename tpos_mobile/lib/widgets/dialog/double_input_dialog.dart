...
class DoubleInputDialog extends StatefulWidget {
  const DoubleInputDialog({Key key, this.initValue, this.selectAllText = true, this.hint}) : super(key: key);

  @override
  _DoubleInputDialogState createState() => _DoubleInputDialogState();
...
class _DoubleInputDialogState extends State<DoubleInputDialog> {
  ...
  final RegExInputFormatter _validator = RegExInputFormatter.withRegex('^\$|^(0|([1-9][0-9]{0,}))(\\.[0-9]{0,})?\$');
  ...
  @override
  void initState() {
    _valueController.text = widget.initValue.toString();
              ...
              child: Column(
                ...
                children: <Widget>[
                  TextField(
                    ...
                    maxLines: 1,
                    inputFormatters: <TextInputFormatter>[_validator],
                      ...
                      Flexible(
                        child: ClipRRect(
                          ...
                          child: AppButton(
                            ...
                            padding: const EdgeInsets.only(left: 20, right: 20),
                            onPressed: () {
                              Navigator.of(context).pop(double.tryParse(_valueController.text));
                            },
                            child: Container(
                                alignment: Alignment.centerRight,
                                child: Center(
...
Future<double> showDoubleInputDialog(BuildContext context, double initValue) {
