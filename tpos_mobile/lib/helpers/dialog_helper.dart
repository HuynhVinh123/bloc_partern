...
Future<void> showDialogApp(
    {BuildContext context, DialogType type, String title, String message, List<Widget> actions}) async {
  switch (type) {
    case DialogType.warning:
      _showDialogBase(
          context: context,
    ...
    builder: (context) => AlertDialog(
        ...
        actions: actions ??
            [
              Container(
                height: 32,
                decoration: BoxDecoration(borderRadius: BorderRadius.circular(6), color: const Color(0xFF28A745)),
                child: FlatButton(
