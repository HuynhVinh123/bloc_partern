...
class _LanguageItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      selected: selected,
      onTap: () {
        context.read<LanguageBloc>().add(LanguageChanged(locale.languageCode));
...
MoneyMaskedTextController getMoneyController({initialValue = 0.0}) {
...
Key getFieldKey(String prefix, String key) {
