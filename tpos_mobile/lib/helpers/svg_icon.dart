...
class SvgIcon extends StatelessWidget {
  ...
  static const warningOrange = "assets/icon/warning.svg";
  static const deposit = "assets/icon/deposit.svg";
  static const emptyDataProduct = "assets/icon/empty-image-product.svg";
  static const reload = "assets/icon/reload.svg";
  static const facebook = "assets/icon/icon_fb.svg";
  static const searchNoData = "assets/icon/no-result.svg";
