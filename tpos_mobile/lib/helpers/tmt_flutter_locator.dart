...
///
///
@Deprecated("Thay thế bằng get_it package")
class TmtFlutterLocator {
  ...
  final _factories = <Type, _ServiceFactory<dynamic>>{};
  final _factoriesByName = <String, _ServiceFactory<dynamic>>{};
  ...
  void resetViewModel<T extends ScopedViewModel>() {
    final instance = _factories[T];
    if (instance != null) {
      (instance.instance as ScopedViewModel).dispose();
