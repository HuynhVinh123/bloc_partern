...
class FastSaleOrderAddEditFullShipInfoPage extends StatefulWidget {
  const FastSaleOrderAddEditFullShipInfoPage({@required this.editVm});
...
class _FastSaleOrderAddEditFullShipInfoPageState
  ...
  final _deliverNoteController = TextEditingController();
  ...
  Widget _buildBody() {
    ...
    const TextStyle defaultNumberStyle = TextStyle(fontWeight: FontWeight.bold);
                    ...
                    if (_vm.shipExtra != null &&
                      ...
                      Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            ListTile(
                              title: const Text("Ca lấy hàng:"),
                              trailing: SizedBox(
                                width: 200,
                                child: DropdownButton<String>(
                                    hint: const Text("Chọn ca lấy hàng"),
                                    isExpanded: true,
                                    value:
                                        widget.editVm.shipExtra?.pickWorkShift,
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          // Checkbox.
                          final itemWidget = CheckboxListTile(
                            title: Text(
...
class _CarrierSelectPanel extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final _vm = ScopedModel.of<FastSaleOrderAddEditFullViewModel>(context);
    return Container(
      color: Colors.white,
      child: ListTile(
        leading: Row(
...
class _NumberInputField extends StatelessWidget {
  const _NumberInputField(
      ...
      this.title,
      this.defaultNumberStyle = const TextStyle(fontWeight: FontWeight.bold)});
    ...
    return ListTile(
      ...
      trailing: SizedBox(
          ...
          child: TextField(
            ...
            onChanged: (text) {
              final double value = App.convertToDouble(text, "vi_VN");
