...
class PosPointSaleEditViewModel extends ViewModelBase {
    ...
    try {
      ...
      if (result) {
        _dialog.showNotify(
            ...
            message: S.current.posOfSale_inforUpdateSuccess);
  ...
  void handleAddAccountJournal(PosMakePaymentJournal value) {
