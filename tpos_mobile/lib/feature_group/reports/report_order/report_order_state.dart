...
/// Loading khi lấy danh sách hóa đơn của khách hàng
class ReportOrderPartnerInvoiceLoading extends ReportOrderState {}

/// Load more Loading khi lấy danh sách hóa đơn của khách hàng
class ReportOrderPartnerInvoiceLoadMoreLoading extends ReportOrderState {}
...
/// Trả về dữ liệu khi load danh sách hóa đơn khách hàng thanh công
class InvoiceReportCustomerTypeSaleLoadSuccess extends ReportOrderState {
  InvoiceReportCustomerTypeSaleLoadSuccess({this.invoiceReportCustomers});
  List<DetailReportCustomerTypeSale> invoiceReportCustomers;
}
/// Trả về dữ liệu khi load danh sách hóa đơn cho nhân viên thanh công
class InvoiceReportEmployeeTypeSaleLoadSuccess extends ReportOrderState {
  InvoiceReportEmployeeTypeSaleLoadSuccess({this.invoiceReportEmployees});
  List<DetailReportCustomerTypeSale> invoiceReportEmployees;
}
