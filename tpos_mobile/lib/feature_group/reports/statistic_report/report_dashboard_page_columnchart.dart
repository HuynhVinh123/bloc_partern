      ...
      return Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Flexible(child: Text(_vm.dataColumns[0].listCompanyName[index]))
          ],
        ),
      );
    }));
          ...
          BarChartData(
              ...
              titlesData: FlTitlesData(
                ...
                bottomTitles: SideTitles(
                  reservedSize: 30,
                  showTitles: true,
                  // textStyle: const TextStyle(color: Colors.black, fontSize: 10), //TODO Check xem
                  margin: 10,
                  rotateAngle: 0,
