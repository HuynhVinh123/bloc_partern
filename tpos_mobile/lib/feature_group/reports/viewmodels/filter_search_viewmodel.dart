...
class FilterSearchViewModel extends ViewModelBase {
  ...
  Future<void> getSuppliers() async {
    setState(true);
    try {
      final result = await _tposApi.getSupplierSearchs();
      if (result != null) {
        suppliers = result;
      }
      setState(false);
  ...
  Future<void> getPartnerCategorys() async {
    setState(true);
    try {
      final result = await _partnerCategoryApi.getList();
      if (result != null) {
  ...
  Future<void> getListPartnerFPO() async {
    setState(true);
    try {
      final result = await _tposApi.getPartnerSearchReport();
      if (result != null) {
        partnerFPOs = result;
      }
      setState(false);
  ...
  Future<void> getApplicationUserSearchReport() async {
    setState(true);
    try {
      final result = await _tposApi.getApplicationUserSearchReport();
      if (result != null) {
  ...
  Future<void> getCompanies() async {
    setState(true);
    try {
      final result = await _tposApi.getCompanies();
      if (result != null) {
