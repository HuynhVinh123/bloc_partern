...
class _ReportStockOverviewPageState extends State<ReportStockOverviewPage>
  ...
  bool _isFilterByProductCategory = false;
  bool _isFilterByWarehouseStock = false;
  bool _isFilterByKeyWord = false;
                ...
                return InkWell(
                  onTap: () {
                    if (!_isFirstLoadFilter) {
                      _stockFilter.isFilterByKeyWord = _isFilterByKeyWord;
                      _stockFilter.isFilterByWarehouseStock =
                          _isFilterByWarehouseStock;
                      _stockFilter.isFilterByProductCategory =
                          _isFilterByProductCategory;
  ...
  void onUpdateFilter(StockFilter stockFilter) {
    ...
    _isFilterByProductCategory = stockFilter.isFilterByProductCategory;
    _isFilterByWarehouseStock = stockFilter.isFilterByWarehouseStock;
    _isFilterByKeyWord = stockFilter.isFilterByKeyWord;
