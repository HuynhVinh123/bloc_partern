...
import 'package:tpos_mobile/feature_group/reports/report_delivey/uis/report_delivery_invoice_customer_list_page.dart';
...
class _ReportDeliveryOrderPartnerPageState
              ...
              child: ListTile(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (ctx) => ReportDeliveryOrderCustomerListPage(
                              bloc: widget.bloc,
  ...
  void openFacebook(String id) {
    if (id != null && id != '') {
      url_launcher.launch('https://www.facebook.com/$id');
    }
  }
