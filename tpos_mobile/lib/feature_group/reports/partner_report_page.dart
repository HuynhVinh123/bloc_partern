...
class _PartnerReportPageState extends State<PartnerReportPage> {
  final _viewModel = locator<PartnerReportViewModel>();
    ...
    return AppFilterDrawerContainer(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Visibility(
            visible: _viewModel.positionReport == "1",
            child: Padding(
              ...
              child: Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Visibility(
                      visible: _viewModel.partnerCategory != null,
                      child: Container(
                        width: 45,
                        height: 45,
                        child: InkWell(
              ...
              child: Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Visibility(
                      visible: _viewModel.partnerFPO != null,
                      child: Container(
                        width: 45,
                        height: 45,
                        child: InkWell(
              ...
              child: Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Visibility(
                      visible: _viewModel.applicationUserFPO != null,
                      child: Container(
                        width: 45,
                        height: 45,
                        child: InkWell(
