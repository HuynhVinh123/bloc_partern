                ...
                return Column(
                  children: <Widget>[
                    ...
                    if (_vm.selectedPrintDevice?.type == 'esc_pos' &&
                        _vm.shipTemplateSize == 'BILL80-IMAGE') ...[
                      sizedBoxMin,
                      Container(
                        decoration: decorate,
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              child: DropdownButton<FontScale>(
                                ...
                                onChanged: (value) {
                                  setState(() {
                                    _vm.setShipFontScale(value);
                                  });
                                },
                                value: _vm.shipFontScale,
                              ),
                              padding:
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          //Hiện tiền cọc
                          CheckboxListTile(
                            value: _vm.isShowDepositAmount,
                            title:
                                Text(S.current.setting_printerShipShowDeposit),
                            onChanged: (value) {
                              setState(() {
                                _vm.setShowDepositAmount(value);
                              });
                            },
                          ),
                          // /Hiện số lượng sản phẩm
                          CheckboxListTile(
                            value: _vm.isShowProductQuantity,
                            title: Text(S.current
                                .setting_printerShipShowNumberOfProduct),
                            onChanged: (value) {
                              setState(() {
                                _vm.setShowProductQuantity(value);
                              });
                            },
                          ),
                          // Hiện ghi chú hóa đơn
                          CheckboxListTile(
                            value: _vm.isShowInvoiceNote,
                            title: Text(
                                S.current.setting_printerShipShowInvoiceNote),
                            onChanged: (value) {
                              setState(() {
                                _vm.setShowInvoiceNote(value);
                              });
                            },
                          ),
                        ],
