...
import 'package:tpos_mobile/feature_group/sale_online/viewmodels/setting_printer_add_printer_viewmodel.dart';
  ...
  void _save() {
    if (_formKey.currentState.validate()) {
      ...
      _scaffoldKey.currentState.showSnackBar(
          const SnackBar(content: Text("Vui lòng nhập các trường còn thiếu")));
    }
  }
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          ListTile(
            ...
            subtitle:
                const Text("Nếu máy in của bạn không có trong danh sách trên"),
          )
        ],
      ),
    );
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            TextFormField(
              ...
              decoration:
                  const InputDecoration(labelText: "Ghi chú:", hintText: ""),
            ),
          ],
        ),
      ),
