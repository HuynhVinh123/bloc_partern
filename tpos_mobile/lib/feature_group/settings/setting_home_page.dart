...
//        ),
        const Divider(),
        ListTile(
          title: Text("Giao diện màn hình chủ"),
          subtitle: Column(
            children: <Widget>[
              RadioListTile<String>(
                title: Text("Phong cách 1 (Mặc định)"),
                value: 'style1',
                groupValue: _config.homePageStyle,
                onChanged: (value) {
                  setState(
                    () {
                      _config.setHomePageStyle("style1");
                    },
                  );
                },
              ),
              RadioListTile<String>(
                // Toàn bộ chức năng
                title: Text("Phong cách 2"),
                value: "style2",
                groupValue: _config.homePageStyle,
                onChanged: (value) {
                  setState(() {
                    _config.setHomePageStyle("style2");
                  });
                },
              ),
            ],
