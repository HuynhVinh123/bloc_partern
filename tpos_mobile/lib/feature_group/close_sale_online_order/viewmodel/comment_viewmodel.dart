...
class CommentViewModel {
  CommentViewModel({
    ...
    _saleOnlineOrderApi =
        saleOnlineOrderApi ?? GetIt.instance<SaleOnlineOrderApi>();
  ...
  List<CommentData> _viewComments;
      ...
      CommentWrapperMiddleware(
        onReceiver: (CommentData comment) {
          ...
          if (lastItem.length <= PAGE_SIZE) {
            ...
            List<CommentData> newList = <CommentData>[
              comment,
            ];
        ...
        onReceiver: (orderData) {
          ...
          if (orderData.lastComment != null) {
            ...
            if (_product != null) {
              ...
              orderData.order.details = new List<SaleOnlineOrderDetail>();
  ...
  Future<void> _addCommentFromFacebookComment(FacebookComment comment) async {
    ...
    for (CommentMiddleware middleware in _commentMiddlewares) {
  ...
  Future<void> _saveOrder(OrderData orderData) {
  ...
  Future<void> _addOrder(OrderData order) async {
    ...
    for (OrderMiddleware middleware in _orderMiddlewares) {
  ...
  Future<void> handleCreateOrder({CommentData commentData}) {
    _addOrder(
      OrderData(
