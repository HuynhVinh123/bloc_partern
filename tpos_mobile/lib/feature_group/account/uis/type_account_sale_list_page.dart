                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Text(
                            "${item.name} ",
                            style: const TextStyle(
                                fontSize: 16, color: Color(0xFF2C333A)),
                          ),
                          sizedBox,
                          Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            ...
                            children: <Widget>[
                              const Icon(FontAwesomeIcons.houseDamage,
                                  color: Color(0xFF929daa), size: 14),
                              ...
                              const Icon(FontAwesomeIcons.fileCode,
                                  color: Color(0xFF929daa), size: 13),
                              const SizedBox(width: 4),
                              Flexible(
                                  flex: 1,
                                  child: Text(
                                      '${S.current.code}: ' + item.code ?? "",
                                      style: const TextStyle(fontSize: 14)))
                            ],
                          ),
                        ],
