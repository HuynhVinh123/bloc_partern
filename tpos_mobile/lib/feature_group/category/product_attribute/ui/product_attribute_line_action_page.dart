...
class ProductAttributeLineActionPage extends StatefulWidget {
  const ProductAttributeLineActionPage({Key key, this.isSearch = false})
      : super(key: key);

  @override
  _ProductAttributeLineActionPageState createState() =>
      _ProductAttributeLineActionPageState();
  final bool isSearch;
}

class _ProductAttributeLineActionPageState
    extends State<ProductAttributeLineActionPage> {
        ...
        child: SearchAppBar(
          ...
          onKeyWordChanged: (String keyword) {
            if (_keyword != keyword) {
              ...
              // _productAttributeBloc = ProductAttributeLineBloc();
              setState(() {});
              _productAttributeBloc
                  .add(ProductAttributeLineSearched(keyword: keyword));
            }
          },
                ...
                child: Material(
                  ...
                  child: IconButton(
                    ...
                    onPressed: () async {
                      ...
                      _productAttribute =
                          ProductAttribute(sequence: 0, name: '', code: '');
                      ...
                      if (_productAttribute != null) {
                        _codeController.text = '';
                        _nameController.text = '';
                        _productAttributeBloc.add(ProductAttributeInserted(
                            productAttribute: _productAttribute));
                      }
                    },
                  ),
  ...
  Widget _buildBody() {
    return BaseBlocListenerUi<ProductAttributeLineBloc,
        ProductAttributeLineState>(
              ...
              LoadStatusWidget(
                ...
                action: ClipRRect(
                  ...
                  child: AppButton(
                    onPressed: () {
                      _productAttributeBloc
                          .add(ProductAttributeLineRefreshed());
                    },
                    width: null,
      ...
      builder: (BuildContext context, ProductAttributeLineState state) {
        return state.productAttributes.isEmpty
            ? _buildEmptyList()
            : _buildAttributes(state.productAttributes);
      },
    );
  }
    ...
    return ListView.separated(
      ...
      itemBuilder: (BuildContext context, int index) {
        return InkWell(
          onTap: () {
            if (widget.isSearch) {
              Navigator.of(context).pop(attributes[index]);
            }
          },
          child: Column(
            children: [
              Padding(
                padding: EdgeInsets.only(
                    left: 16, right: widget.isSearch ? 16 : 0, top: 10),
                child: Row(
        ...
        ? SingleChildScrollView(
            ...
            children: [
              ...
              LoadStatusWidget(
                ...
                content:
                    S.of(context).searchNotFoundAttributeWithKeyword(_keyword),
            ...
            children: [
              ...
              LoadStatusWidget.empty(
                ...
                content: S.of(context).emptyNotificationParam(
                    S.of(context).attribute.toLowerCase()),
                action: ClipRRect(
                  borderRadius: BorderRadius.circular(24),
                  child: AppButton(
                    onPressed: () async {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _buildTextField(
                                  ...
                                  hint: S.of(context).enterParam(
                                      S.current.attributeCode.toLowerCase())),
                              Text(
                              ...
                              _buildTextField(
                                  ...
                                  hint: S.of(context).enterParam(
                                      S.current.attributeName.toLowerCase())),
                              _buildSequence(),
                                      ...
                                      onPressed: () {
                                        if (_nameController.text == '') {
                                          App.showDefaultDialog(
                                              ...
                                              content: S
                                                  .of(context)
                                                  .canNotBeEmptyParam(S
                                                      .of(context)
                                                      .attributeName),
                                              type: AlertDialogType.warning);
                                        } else {
                                          _productAttribute.name =
                                              _nameController.text;
                                          _productAttribute.code =
                                              _codeController.text;

                                          Navigator.pop(
                                              context, _productAttribute);
                                        }
                                      },
                                    ),
                                  ),
  ...
  Widget _buildSequence() {
    return Column(
      children: [
        ...
        Row(
          children: [
            Text(S.of(context).orderAttribute,
                style: const TextStyle(color: Color(0xff2C333A), fontSize: 17)),
            const SizedBox(width: 10),
            Expanded(
                          ...
                          child: Material(
                            child: InkWell(
                              onTap: () async {
                                _productAttribute.sequence ??= 0;
                                final double number =
                                    await showNumberInputDialog(context,
                                        _productAttribute.sequence.toDouble());
                                if (number != null) {
                              ...
                              child: Container(
                                padding: const EdgeInsets.only(
                                    left: 10, right: 10, bottom: 9, top: 9),
                                decoration: BoxDecoration(
                                ...
                                child: Text(
                                  _productAttribute != null
                                      ? _productAttribute.sequence.toString()
                                      : '0',
  ...
  Widget _buildBottomSheet(
      BuildContext context, ProductAttribute productAttributeLine) {
    return SingleChildScrollView(
      child: Column(
        children: [
          const SizedBox(height: 20),
            ...
            child: AppButton(
              ...
              onPressed: () async {
                ...
                _productAttribute = ProductAttribute(
                    id: productAttributeLine.id,
                    name: productAttributeLine.name,
                    createVariant: productAttributeLine.createVariant,
                    sequence: productAttributeLine.sequence,
                    code: productAttributeLine.code);
                ...
                if (_productAttribute != null) {
                  _codeController.text = '';
                  _nameController.text = '';
                  _productAttributeBloc.add(ProductAttributeUpdated(
                      productAttribute: _productAttribute));
                }
              },
              child: Row(
                children: [
                  ...
                  Text(
                    S
                        .of(context)
                        .editParam(S.of(context).attribute.toLowerCase()),
                    style:
              ...
              builder: (BuildContext context,
                ...
                return AppButton(
                  ...
                  onPressed: () async {
                    ...
                    if (result != null && result) {
                      _productAttributeBloc.add(ProductAttributeDeleted(
                          productAttributeLine: productAttributeLine));
                      Navigator.pop(context);
                    }
                  },
                  child: Row(
                    children: [
                      ...
                      Text(
                        S
                            .of(context)
                            .deleteParam(S.of(context).attribute.toLowerCase()),
                        style: const TextStyle(
                            color: Color(0xff2C333A), fontSize: 17),
                      )
                    ],
