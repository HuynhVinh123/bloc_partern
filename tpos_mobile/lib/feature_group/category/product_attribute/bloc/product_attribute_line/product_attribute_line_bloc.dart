  ...
  Stream<ProductAttributeLineState> mapEventToState(ProductAttributeLineEvent event) async* {
    if (event is ProductAttributeLineStarted) {
      ...
      try {
        ...
        await _productAttributeValueApi.insert(event.productAttribute);
      ...
      try {
        ...
        await _productAttributeValueApi.update(event.productAttribute);
      ...
      try {
        ...
        _productAttributes.remove(event.productAttributeLine);
