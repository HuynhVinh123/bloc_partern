...
class ProductTemplateAssignTagFailure extends ProductTemplateState {
  ProductTemplateAssignTagFailure(
      {this.error,
        BaseListOrderBy orderBy,
        List<ProductTemplate> productTemplates,
        List<ProductTemplate> productTemplateExecutes,
...
class ProductTemplateAssignTagSuccess extends ProductTemplateLoadSuccess {
  ProductTemplateAssignTagSuccess(
      {BaseListOrderBy orderBy,
        List<ProductTemplate> productTemplates,
        List<ProductTemplate> productTemplateExecutes,
        List<ProductCategory> productCategories,
