...
class _AnotherProductInfoPageState extends State<AnotherProductInfoPage> {
  ...
  void initState() {
    ...
    _descriptionController.text = _productTemplate.description ?? '';
    _elementController.text = _productTemplate.element ?? '';
    _specificationsController.text = _productTemplate.specifications ?? '';
    _infoWarningController.text = _productTemplate.infoWarning ?? '';
      ...
      actions: <Widget>[
        IconButton(
            ...
            onPressed: () {
              ...
              _productTemplate.producerId = _producer?.id;
              _productTemplate.producerName = _producer?.name;
              _productTemplate.importer = _importer;
              _productTemplate.importerId = _importer?.id;
              _productTemplate.importerName = _importer?.name;
              _productTemplate.distributor = _distributor;
              _productTemplate.distributorId = _distributor?.id;
              _productTemplate.distributorName = _distributor?.name;

              _productTemplate.originCountry = _originCountry;
              _productTemplate.originCountryId = _originCountry?.id;
              _productTemplate.originCountryName = _originCountry?.name;
