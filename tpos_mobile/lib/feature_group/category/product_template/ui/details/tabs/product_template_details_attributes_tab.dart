...
class ProductDetailsVariantAttributesTab extends StatefulWidget {
  const ProductDetailsVariantAttributesTab({Key key, this.onChanged}) : super(key: key);

  @override
  _ProductDetailsVariantAttributesTabState createState() => _ProductDetailsVariantAttributesTabState();
  final Function() onChanged;
}

class _ProductDetailsVariantAttributesTabState extends State<ProductDetailsVariantAttributesTab> {
  ...
  @override
  void initState() {
    _productDetailsVariantBloc = BlocProvider.of<ProductDetailsVariantBloc>(context);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Container(
      color: Colors.white,
      child: BaseBlocListenerUi<ProductDetailsVariantBloc, ProductDetailsVariantState>(
    ...
    return Column(
      children: [
        ...
        LoadStatusWidget.empty(
          ...
          content: S.of(context).emptyNotificationParam(S.of(context).variant.toLowerCase()),
          // action: AppButton(
          //   onPressed: () {},
          //   width: 180,
          //   decoration: const BoxDecoration(
      ...
      child: Column(
        children: [
          Row(
            ...
            children: <Widget>[
              Padding(
                padding: const EdgeInsets.only(top: 0, bottom: 0, left: 0, right: 13),
                child: Container(
                  width: 60,
                  height: 60,
                          ...
                          Flexible(
                            child: Padding(
                              ...
                              child: Text(
                                ...
                                style: const TextStyle(
                                    color: Color.fromARGB(255, 235, 59, 91), fontSize: 15, fontWeight: FontWeight.w500),
                              ),
                            ),
                          ),
                      ],
              ...
              Text(
                product.listPrice.toVietnameseCurrencyFormat(null, Localizations.localeOf(context).languageCode),
                style: const TextStyle(
                    color: Color.fromARGB(255, 107, 114, 128), fontSize: 15, fontWeight: FontWeight.bold),
              ),
              const SizedBox(width: 12),
            ],
          ),
          if (product.displayAttributeValues != null && product.displayAttributeValues != '')
            Padding(
  ...
  Widget _buildAttributes(List<ProductAttributeValue> tags) {
    return Row(
      children: [
        Wrap(
          spacing: 10,
          children: tags.map((ProductAttributeValue productAttribute) => _buildAttribute(productAttribute)).toList(),
        ),
      ],
    );
  }
