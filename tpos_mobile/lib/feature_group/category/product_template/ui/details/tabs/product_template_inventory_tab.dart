...
class ProductTemplateInventoryTab extends StatefulWidget {
  ...
  @override
  _ProductTemplateInventoryTabState createState() =>
      _ProductTemplateInventoryTabState();
}

class _ProductTemplateInventoryTabState
    extends State<ProductTemplateInventoryTab> {
  ...
  void initState() {
    _productDetailsInventoryProductBloc =
        BlocProvider.of<ProductDetailsInventoryProductBloc>(context);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return BaseBlocListenerUi<ProductDetailsInventoryProductBloc,
            ProductDetailsInventoryProductState>(
        listener: (BuildContext context,
            ProductDetailsInventoryProductState state) {},
        loadingState: ProductDetailsInventoryProductLoading,
        errorState: ProductDetailsInventoryProductLoadFailure,
        errorBuilder:
            (BuildContext context, ProductDetailsInventoryProductState state) {
    ...
    return Column(
      children: [
        ...
        LoadStatusWidget.empty(
          ...
          content: S
              .of(context)
              .emptyNotificationParam(S.of(context).inventory.toLowerCase()),
          // action: AppButton(
          //   onPressed: () {},
          //   width: 180,
          //   decoration: const BoxDecoration(
  ...
  Widget _buildInventories() {
    ...
    return SmartRefresher(
      ...
      onLoading: () async {
        _productDetailsInventoryProductBloc
            .add(ProductDetailsInventoryProductLoadMore());
      },
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Row(
                          ...
                          children: [
                            Text(
                                '${S.of(context).summaryParam(S.of(context).stock.toLowerCase())}: ',
                                style: const TextStyle(
                                    color: Color(0xff929DAA), fontSize: 17)),
                            Text(
                              total.toVietnameseCurrencyFormat(null,
                                  Localizations.localeOf(context).languageCode),
                              style: const TextStyle(
                                  color: Color(0xff28A745), fontSize: 19),
                            ),
                          ],
                        ),
                      ),
