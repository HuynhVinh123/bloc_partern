...
class ProductTemplateStockMoveTab extends StatefulWidget {
  ...
  @override
  _ProductTemplateStockMoveTabState createState() => _ProductTemplateStockMoveTabState();
}

class _ProductTemplateStockMoveTabState extends State<ProductTemplateStockMoveTab> {
  ...
  final DateFormat dateFormat = DateFormat('MM/dd/yyyy  HH:mm', 'en_US');

  StockType _stockTypeFilter = StockType.ALL;

  @override
  void initState() {
    _productDetailsStockMoveBloc = BlocProvider.of<ProductDetailsStockMoveBloc>(context);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return BaseBlocListenerUi<ProductDetailsStockMoveBloc, ProductDetailsStockMoveState>(
          ...
          child: Column(
            children: [
              ...
              LoadStatusWidget(
                ...
                action: AppButton(
                  onPressed: () {
                    _productDetailsStockMoveBloc.add(ProductDetailsStockMoveRefresh());
                  },
                  width: 180,
      ...
      child: Column(
        children: [
          ...
          LoadStatusWidget.empty(
            ...
            content: S.of(context).emptyNotificationParam(S.of(context).stockMove.toLowerCase()),
            // action: AppButton(
            //   onPressed: () {},
            //   width: 180,
            //   decoration: const BoxDecoration(
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton<StockType>(
                ...
                onChanged: (StockType stockType) {
                  ...
                  _productDetailsStockMoveBloc.add(ProductDetailsStockMoveFilter(filter: stockType));
                },
            ...
            children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                            color:
                                stockMove.type.contains('Xuất kho') ? const Color(0xffEB3B5B) : const Color(0xff28A745),
                            fontSize: 19,
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    stockMove.date != null ? dateFormat.format(stockMove.date.toLocal()) : '',
                    style: const TextStyle(color: Color(0xff929DAA), fontSize: 15),
                  ),
                ],
              ),
