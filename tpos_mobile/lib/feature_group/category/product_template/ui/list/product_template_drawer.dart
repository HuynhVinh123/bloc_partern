...
class ProductTemplateEndDrawer extends StatefulWidget {
  const ProductTemplateEndDrawer({Key key, this.productTemplateBloc})
      : super(key: key);

  @override
  _ProductTemplateEndDrawerState createState() =>
      _ProductTemplateEndDrawerState();
...
class _ProductTemplateEndDrawerState extends State<ProductTemplateEndDrawer> {
  ...
  void initState() {
    ...
    widget.productTemplateBloc.add(ProductTemplateOpenFilter());
    super.initState();
  }
      ...
      child: Container(
        ...
        child: Column(
          children: [
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Center(
                            ...
                            style: const TextStyle(
                                color: Color.fromARGB(255, 0, 142, 48),
                                fontSize: 16),
                          )),
                        ),
                      ],
            ...
            Expanded(
              child:
                  BaseBlocListenerUi<ProductTemplateBloc, ProductTemplateState>(
                buildWhen:
                    (ProductTemplateState last, ProductTemplateState current) {
                      ...
                      Row(
                        children: [
                          ...
                          Flexible(
                            child: AppButton(
                              onPressed: () {
                                widget.productTemplateBloc.add(
                                    ProductTemplateFiltered(
                                        isFilterByCategory: false,
                                        isFilterByProductPrice: false,
                                        isFilterByTag: false));
                              },
                                  ...
                                  onPressed: () {
                                    widget.productTemplateBloc.add(
                                        ProductTemplateFiltered(
                                            isFilterByCategory:
                                                _isFilterByCategory,
                                            isFilterByProductPrice:
                                                _isFilterByProductPrice,
                    ...
                    child: Wrap(
                      ...
                      children: _productCategories
                              .map((ProductCategory productCategory) =>
                                  _buildFilterItem(productCategory.name ?? '',
                                      () {
                                    setState(() {
                                      _productCategories
                          ...
                          [
                            _buildAddButton(
                                S.of(context).addAnotherProductCategoryFilter,
                                () async {
                  ...
                  Expanded(
                    child: Wrap(
                      ...
                      children: _filterTags
                              ...
                              .toList() +
                          [
                            _buildAddButton(S.of(context).addAnotherTagFilter,
                                () async {
          ...
          child: DropdownButton<ProductPrice>(
            ...
            hint: Padding(
              ...
              child: Text(
                ...
                style:
                    const TextStyle(color: Color.fromARGB(255, 146, 157, 170)),
              ),
            ),
            value: _productPrice,
            isExpanded: true,
        ...
        Container(
          ...
          child: Row(
            children: [
              Text(name,
                  style: const TextStyle(
                      color: Color.fromARGB(255, 44, 51, 58), fontSize: 15)),
              ClipOval(
                child: Container(
                  height: 35,
                  width: 40,
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  name,
                  style: const TextStyle(
                      color: Color.fromARGB(255, 40, 167, 69), fontSize: 15),
                ),
...
class _ItemCheck extends StatefulWidget {
  const _ItemCheck(
      {Key key, this.check = false, this.name, this.onCheckChanged, this.body})
      : super(key: key);
