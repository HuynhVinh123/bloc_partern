...
class _CustomProductSliverState extends State<CustomProductSliver>
  ...
  Widget build(BuildContext context) {
    ...
    _rightTextFieldAnimation =
        CurvedAnimation(parent: _controller, curve: Curves.easeInOut);
    _rightTextFieldAnimation =
        Tween<double>(begin: 50, end: 80).animate(_rightTextFieldAnimation);

    _heightAnimation =
        CurvedAnimation(parent: _controller, curve: Curves.easeInOut);
    _heightAnimation =
        Tween<double>(begin: 120, end: 80).animate(_heightAnimation);
    ...
    _rightFilterAnimation =
        CurvedAnimation(parent: _controller, curve: Curves.easeInOut);
    _rightFilterAnimation =
        Tween<double>(begin: 10, end: 40).animate(_rightFilterAnimation);

    _topFilterAnimation =
        CurvedAnimation(parent: _controller, curve: Curves.easeInOut);
    _topFilterAnimation =
        Tween<double>(begin: 60, end: 15).animate(_topFilterAnimation);
                    ...
                    Positioned(
                        ...
                        child: Container(
                            ...
                            decoration: const BoxDecoration(
                                ...
                                color: Colors.red),
                            child: Center(
                                child: BlocBuilder<ProductTemplateBloc,
          ...
          children: <Widget>[
            ...
            IconButton(
              icon: Image.asset("images/scan_barcode.png",
                  width: 28,
                  height: 24,
                  color: const Color.fromARGB(183, 243, 253, 242)),
              onPressed: () async {
