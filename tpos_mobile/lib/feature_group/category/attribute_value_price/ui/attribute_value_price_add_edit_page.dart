    ...
    return AppBar(
      title: Text(
        widget.productAttributeValue != null
            ? S.of(context).editNormalParam(S.of(context).variantPrice.toLowerCase())
            : S.of(context).addNewParam(S.of(context).variantPrice.toLowerCase()),
    ...
    if (_productAttributeValue != null) {
      if (_valueController.text == '') {
        App.showDefaultDialog(
            ...
            content: S.of(context).canNotBeEmptyParam(S.of(context).value));
        return;
      }

      if (_productAttributeValue.productAttribute == null) {
        App.showDefaultDialog(
            title: S.of(context).error,
            context: context,
            type: AlertDialogType.error,
            content: S.of(context).canNotBeEmptyParam(S.of(context).attribute));
        return;
      }
                      ...
                      builder: (BuildContext context, void Function(void Function()) setState) {
                        return InkWell(
                          onTap: () async {
                            ...
                            if (result != null) {
                              _productAttributeValue.productAttribute = result;
                        ...
                        Expanded(
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                                ...
                                hintStyle: const TextStyle(color: Color(0xff929DAA), fontSize: 15),
                                ...
                                children: [
                                        ...
                                        child: InkWell(
                                          child: RichText(
                                            text: TextSpan(style: DefaultTextStyle.of(context).style, children: [
                                              TextSpan(
                                                text: '${_extraPriceController.text} ',
                                  ...
                                  TextField(
                                    ...
                                    decoration: const InputDecoration(
                                        ...
                                        hintStyle: TextStyle(color: Color(0xff929DAA), fontSize: 15),
                                        focusedBorder: InputBorder.none,
                                        enabledBorder: InputBorder.none),
                                  ),
                                ],
