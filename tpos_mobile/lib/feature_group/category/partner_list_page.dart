...
class _PartnerListPageState extends State<PartnerListPage> {
  ...
  Widget _buildEmptyList() {
    ...
    final PageStateActionButton _addButton = PageStateActionButton(
      icon: const Icon(
        Icons.add,
        color: Colors.white,
      ),
    ...
    final PageStateActionButton _refreshButton = PageStateActionButton(
      icon: const Icon(
        Icons.refresh,
        color: Colors.white,
      ),
    ...
    final PageStateActionButton _openFilterButton = PageStateActionButton(
      icon: const Icon(
        Icons.filter,
        color: Colors.white,
      ),
