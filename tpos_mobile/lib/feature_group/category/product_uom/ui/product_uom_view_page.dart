            ...
            onPressed: () async {
              if (_productUom != null) {
                ...
                if (result != null && result) {
                  _productUomAddEditBloc.add(ProductUomAddEditDeleted(productUom: _productUom));
                }
              } else {
            ...
            children: [
              ...
              Padding(
                  ...
                  child: _buildFieldRow(
                      ...
                      value: _productUom.rounding != null ? _productUom.rounding.toString() : '')),
              if (_productUom.uOMType != 'reference')
                Padding(
                    padding: const EdgeInsets.only(left: 16, right: 16),
                    child: _buildFieldRow(
                        title: S.of(context).factor,
                        value: _productUom.factor != null ? _productUom.factor.toString() : '')),
              Padding(
