...
class StockChangeProductQuantityProductChangeSuccess extends StockChangeProductQuantityLoadSuccess {
  StockChangeProductQuantityProductChangeSuccess(
...
class StockChangeProductQuantityProductChangeError extends StockChangeProductQuantityState {
  StockChangeProductQuantityProductChangeError({this.error});
