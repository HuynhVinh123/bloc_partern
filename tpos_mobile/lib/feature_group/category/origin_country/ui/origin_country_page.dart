    ...
    return AppBar(
      title: TextField(
        ...
        decoration: InputDecoration(
            ...
            hintText: widget.title ?? S.of(context).selectParam(S.of(context).origin.toLowerCase()),
        ...
        Padding(
          ...
          child: ListTile(
            ...
            leading: CircleAvatar(
              ...
              child: Text(
                  originCountry.name != null && originCountry.name != '' ? originCountry.name.substring(0, 1) : ''),
            ),
          ),
        ),
      ],
    ...
    return SingleChildScrollView(
      ...
      children: [
        ...
        LoadStatusWidget.empty(
          ...
          content: S.of(context).emptyNotificationParam(S.of(context).origin.toLowerCase()),
          action: AppButton(
            onPressed: () async {},
            width: 250,
            decoration: const BoxDecoration(
            ...
            child: Center(
              child: Row(
                ...
                children: [
                  ...
                  const SizedBox(width: 10),
                  Text(
                    S.of(context).addNewParam(S.of(context).origin.toLowerCase()),
                    style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: Colors.white),
                  ),
                ],
              ),
