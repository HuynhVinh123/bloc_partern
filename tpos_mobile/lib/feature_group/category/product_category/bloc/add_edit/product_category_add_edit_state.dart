...
class ProductCategoryAddEditNameError extends ProductCategoryAddEditLoadSuccess {
  ProductCategoryAddEditNameError({ProductCategory productCategory}) : super(productCategory: productCategory);
}

class ProductCategoryAddEditLoading extends ProductCategoryAddEditState {}

class ProductCategoryAddEditDeleteTemporarySuccess extends ProductCategoryAddEditLoadSuccess {
  ProductCategoryAddEditDeleteTemporarySuccess({ProductCategory productCategory, this.isDelete})
