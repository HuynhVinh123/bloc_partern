    ...
    if (event is ProductCategoryAddEditStarted) {
      ...
      try {
        ...
        if (_productCategory.name == '' || _productCategory.name == null) {
          yield ProductCategoryAddEditNameError(productCategory: _productCategory);
          return;
        }
      ...
      try {
        yield ProductCategoryAddEditBusy();
        await _productCategoryApi.setDelete([event.productCategory.id], event.isDelete);
        yield ProductCategoryAddEditDeleteTemporarySuccess(productCategory: _productCategory, isDelete: event.isDelete);
      } catch (e, stack) {
        _logger.e('ProductCategoryAddEditSaveError', e, stack);
        yield ProductCategoryAddEditSaveError(error: e.toString());
      }
      ...
      try {
        ...
        _logger.e('ProductCategoryAddEditSaveError', e, stack);
        yield ProductCategoryAddEditDeleteError(error: e.toString());
      }
    }
  }
}
