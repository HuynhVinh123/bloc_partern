...
class AccountPaymentSaleListViewModel extends ViewModelBase {
  AccountPaymentSaleListViewModel(
    ...
    _keywordController
        .debounceTime(
      const Duration(milliseconds: 400), //TODO Check debounceTime dispablea
    )
        .listen((key) {
  ...
  bool filterByTypeAccountPaymentSale = false;
...
//      showNotify("Xóa dữ liệu thành công!");
  ...
  void saveFilter({bool isOpenDrawer = false}) {
    if (isOpenDrawer) {
      ...
      _isFilterByTypeAccountPaymentSale = filterByTypeAccountPaymentSale;
    } else {
      filterByDate = _isFilterByDate;
      filterByStatus = _isFilterByStatus;
      filterByTypeAccountPaymentSale = _isFilterByTypeAccountPaymentSale;
    }
    notifyListeners();
  }
