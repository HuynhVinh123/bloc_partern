  ...
  void onUpdateFilter() {
    ...
    if (compareDateTime == 1) {
      if (_vm.isFilterByStatus && _vm.filterByStatusString.isEmpty) {
        ...
        if (_vm.isFilterByTypeAccountPaymentSale && _vm.account.name == null) {
          // Lỗi khi chọn loại phiếu chi mà để đối tượng phiếu chi trống
          showErrorFilter(S.current.filter_ErrorSelectPaymentReceiptType);
        } else {
          Navigator.pop(context);
          _vm.isConfirm = true;
          _vm.saveFilter();
        ...
        child: InkWell(
            onTap: () {
              Navigator.push(
                ...
                if (value != null) {
                  ...
                  _vm.filterByTypeAccountPaymentSale = true;
                  _vm.account = value;
            ...
            child: Row(children: <Widget>[
              Expanded(
                ...
                child: Text(
                  _vm.account?.name != null &&
                          _vm.filterByTypeAccountPaymentSale
                      ? _vm.account?.name ?? ""
              ...
              Visibility(
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    _vm.isConfirm = true;
                    _vm.filterByTypeAccountPaymentSale = false;
