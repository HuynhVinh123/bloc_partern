...
class _FastPurchaseOrderAddEditPageState
  ...
  Widget _buildAppbar() {
    return AppBar(
      ...
      title: Text(
        "${widget.isEdit ? S.current.edit : S.current.create} ${S.current.invoice.toLowerCase()} ${_viewModel.isRefund ? S.current.returnTheProduct : S.current.purchase}",
                      ...
                      children: <Widget>[
                        ...
                        SizedBox(
                          ...
                          child: OutlineButton(
                            ...
                            onPressed: () async {
                              // final ScanBarcodeResult barcode =
                              //     await scanBarcode();
