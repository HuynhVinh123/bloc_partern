...
class PrintFastSaleOrderData {
  PrintFastSaleOrderData(
      ...
      this.qrCodeTrackingRefSort,
      this.trackingRefToShow,
      this.shipCode,
      this.changeTrackingRefAndTrackingRefSort,
      this.shipNote,
      this.invoiceNumber,
      this.invoiceNote,
      this.invoiceDate,
  ...
  String carrierName,
      trackingRef,
      trackingRefSort,
      qrCodeTrackingRefSort,
      trackingRefToShow,
      shipCode,
      shipNote;
  bool changeTrackingRefAndTrackingRefSort;
  ...
  Map<String, dynamic> toJson([bool removeIfNull = false]) {
    ...
    data["chang_trackingRef_and_trackingrefsort"] =
        changeTrackingRefAndTrackingRefSort;
    data["TrackingRef"] = trackingRef;
    data["TrackingRefSort"] = trackingRefSort;
    data["QCodeTrackingRefSort"] = qrCodeTrackingRefSort;
    ...
    data["ShowQRtrackingRefSort"] = showQRtrackingRefSort;
    data["User"] = user;
