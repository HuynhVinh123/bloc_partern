...
@Deprecated("BỎ hàm này thay bằng FilterBase trong tpos_api_client")
abstract class OldFilterBase {
  Map<String, dynamic> toJson();
  String toUrlEncode();
}

class OldOdataSortItem {
  OldOdataSortItem({this.dir, this.field});
  String dir;
  String field;
...
@Deprecated("BỎ hàm này thay bằng FilterBase trong tpos_api_client")
class OldOdataFilter extends OldFilterBase {
  OldOdataFilter({this.logic, this.filters});
  String logic;
  List<OldFilterBase> filters;
...
@Deprecated("BỎ hàm này thay bằng FilterBase trong tpos_api_client")
class OldOdataFilterItem extends OldFilterBase {
  OldOdataFilterItem(
      {this.field,
      this.operator,
      this.value,
