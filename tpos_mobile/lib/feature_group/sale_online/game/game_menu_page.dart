...
class GameMenuPage extends StatelessWidget {
  const GameMenuPage({Key key, @required this.commentViewModel}) : super(key: key);
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                            builder: (context) => GameLuckyWheelPage(
                                              postId: commentViewModel.facebookPost.id,
                                              uId: commentViewModel.crmTeam.userUidOrPageId,
                                      ...
                                      NormalMenuItem(
                                        ...
                                        onPressed: () {
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                              builder: (context) => NewGameLuckyWheelPage(
                                                crmTeam: commentViewModel.crmTeam,
                                                postId: commentViewModel.facebookPost?.id                             
                                              ),
                                            ),
                                          );
