      ...
      child: StreamBuilder<List<FacebookPost>>(
        ...
        builder: (ctx, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            } else if (snapshot.data.isEmpty && viewModel.isBusy == false) {
              // return const Center(
              //   child: Text("Không có bài đăng nào để hiển thị."),
              // );

              return PageState.emptyList(
                icon: const SvgIcon(SvgIcon.emptyData),
                description: const Text('Không có bài đăng nào để hiển thị'),
                actions: [
