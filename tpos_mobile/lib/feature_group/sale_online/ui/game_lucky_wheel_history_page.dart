...
class GameLuckyWheelHistoryPage extends StatefulWidget {
  const GameLuckyWheelHistoryPage({Key key, this.players, this.pageAccessToken})
      : super(key: key);

  @override
  _GameLuckyWheelHistoryPageState createState() =>
      _GameLuckyWheelHistoryPageState();
...
class _GameLuckyWheelHistoryPageState extends State<GameLuckyWheelHistoryPage> {
  ...
  void initState() {
    ...
    _luckyWheelWinnerBloc.add(LuckyWheelWinnerInitial(
        players: widget.players, pageAccessToken: widget.pageAccessToken));
    super.initState();
  }
          ...
          child: SearchAppBar(
            ...
            onKeyWordChanged: (String keyword) {
              ...
              _luckyWheelWinnerBloc
                  .add(LuckyWheelWinnerSearched(keyword: _keyword));
            },
            title: 'DS người chơi',
            actions: [
              const SizedBox(width: 10),
      ...
      listener: (BuildContext context, LuckyWheelWinnerState state) {
        if (state is LuckyWheelWinnerMessageSendSuccess) {
          final Widget snackBar =
              getCloseableSnackBar(message: 'Gửi thành công', context: context);
          Scaffold.of(context).showSnackBar(snackBar);
        } else if (state is LuckyWheelWinnerDeleteSuccess) {
          _change = true;
          final Widget snackBar =
              getCloseableSnackBar(message: 'Xóa thành công', context: context);
          Scaffold.of(context).showSnackBar(snackBar);
