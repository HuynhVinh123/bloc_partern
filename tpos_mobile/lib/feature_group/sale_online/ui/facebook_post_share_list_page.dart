...
class _FacebookPostShareListPageState extends State<FacebookPostShareListPage> {
          ...
          appBar: AppBar(
            ...
            actions: <Widget>[
              IconButton(
                ...
                onPressed: () {
                  _vm.isSelectEnable = !_vm.isSelectEnable;
                },
              ),
              FlatButton.icon(
                textColor: Colors.white,
                label: const Text("Đảo ngược"),
              ...
              if (_vm.shareCount != 0)
                Container(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Flexible(
                        child: _itemShare("Người chia sẻ",
                            _vm.userCount.toString(), const Color(0xFF6B7280),
                            onPressed: () {}),
                      ),
                      const SizedBox(
                        width: 8,
                      ...
                      Flexible(
                        // flex: null,
                        child: _itemShare("Cá nhân", _vm.postCount.toString(),
                            const Color(0xFFF25D27), onPressed: () {
                          _vm.sortListByPersonal();
                        }),
                      ),
                      const SizedBox(
                        width: 8,
                      ...
                      Flexible(
                        child: _itemShare("Hội nhóm", _vm.groupCount.toString(),
                            const Color(0xFF2395FF), onPressed: () {
                          _vm.sortListByGroup();
                        }),
                      ),
                      const SizedBox(
                      ...
                      _itemShare(
                          ...
                          const Color(0xFF28A745), onPressed: () {
                        _vm.sortListByTotal();
                      }),
                    ],
                  ),
                  ...
                  children: <Widget>[
                    ...
                    RefreshIndicator(
                        ...
                        child: _vm.shareCount == 0 && _vm.isBusy == false
                            ...
                            : Column(
                                children: [
                                  if (_vm.isSelectEnable) _showSelectMenu(),
                                  Expanded(
                                    child: ListView.separated(
                                      ...
                                      itemCount:
                                          model.facebookShareCounts?.length ??
                                              0,
  ...
  Color _getTextIndexColor(int index) {
    if (index >= 1 && index <= 3) {
      return Colors.white;
    }
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                              image: NetworkImage(item.avatarLink))),
                    ),
                    Positioned(
                      bottom: 0,
                      right: 0,
                      child: Container(
                        ...
                        child: Center(
                          child: Text(
                            "${index + 1}",
                            style: TextStyle(
                                color: _getTextIndexColor(index + 1),
                                fontSize: 11),
                          ),
                        ),
                      ),
        ...
        children: <Widget>[
          Expanded(
            child: CheckboxListTile(
              ...
              title: Row(
                children: <Widget>[
                  Text("Chọn tất cả  (${_vm.selectedCount})"),
                ],
              ),
              activeColor: const Color(0xFF28A745),
              value: _vm.isSelectAll,
              onChanged: (value) => _vm.isSelectAll = value,
            ),
          ),
          Padding(
