...
import 'package:tpos_mobile/feature_group/sale_online/game/game_menu_page.dart';
      ...
      builder: (context) => AlertDialog(
        ...
        actions: <Widget>[
          FlatButton(
            ...
            //"Bỏ chọn
            child: Text(S.current.unchecked),
            onPressed: () {
          ...
          children: <Widget>[
            Row(
              children: <Widget>[
                ...
                RaisedButton(
                  textColor: Colors.white,
                  child: Text(S.current.selectOther),
                  onPressed: () {
                    Navigator.pop(context);
                    _showSelectCampaign();
                  },
...
//      );
  ...
  Future _hideComment(CommentItemModel item) async {
    final dialogResult = await showQuestion(
        context: context,
        title: S.current.hideComment,
        message:
            "${S.current.setting_settingSaleOnlineDoYouWant} ${item.facebookComment.isHidden ? S.current.show.toUpperCase() : S.current.hide.toUpperCase()} comment");
            ...
            ListTile(
              ...
              title: Padding(
                ...
                child: Text(
                  ...
                  style: const cupotino.TextStyle(color: Colors.indigo),
                ),
              ),
              subtitle: Column(
                mainAxisSize: MainAxisSize.min,
                  ...
                  Wrap(
                    ...
                    children: <Widget>[
                      ...
                      if (comment.partnerPhone != null)
                        ...
                        MySizedButton(
                          child: Text(
                            "${S.current.call} ${comment.partnerPhone}",
                            style: const TextStyle(color: Colors.white),
                          ),
                          color: Colors.blue,
                          onTap: () {
            ...
            switch (value) {
              ...
              case "saveAndUpdate":
                _vm.showDialogOpenFileExcel(
                    context: context,
                    content: S.current.facebook_syncAndUpdate,
                    postId: widget.facebookPost.id,
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(
                      S.current.noCommentFoundInThisPost,
                      textAlign: TextAlign.center,
                    ),
                  ],
                ),
                      ...
                      child: InkWell(
                        child: MyMaterialButton(
                          ...
                          content: AutoSizeText(
                            '${_vm.productName ?? S.current.selectProduct} (${_vm.productPrice?.toStringFormat("###,###,###") ?? ''})' ??
                                        ...
                                        children: <Widget>[
                                          ...
                                          if (item.partnerStatusText != null &&
                                            ...
                                            InkWell(
                                              child: Material(
                                                color:
                                                    getPartnerStatusColorFromStatusText(
                                                        item.partnerStatusText),
                                                borderRadius:
                                                    BorderRadius.circular(8),
                                                child: Padding(
