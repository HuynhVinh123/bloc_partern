            ...
            child: Row(
              children: <Widget>[
                ...
                Expanded(
                  ...
                  // Tổng tiền
                  child: Text(
                    "${S.current.quantity}: ${(_viewModel.getQuantity() ?? 0).toStringFormat('###,###,###.##', locate: App.locate)} \n${S.current.totalAmount}: ${vietnameseCurrencyFormat(_viewModel.getSubtotal())}",
              ...
              return Dismissible(
                ...
                background: Container(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Expanded(
                        child: Text("${S.current.saleOnline_deleteProduct}: "),
                      ),
                      RaisedButton(
