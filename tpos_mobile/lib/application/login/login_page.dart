  ...
  void _handleLoginPressed(BuildContext context) {
    _loginBloc.add(
      LoginButtonPressed(
          ...
          shopUrl:
              'https://${_shopUrlController.text.replaceAll('https://', '')}'),
    );
  }
    ...
    return BlocUiProvider<LoginBloc>(
      ...
      listen: (state) {
        if (state is LoginLoadSuccess) {
          _shopUrlController.text = state.shopUrl.replaceAll('https://', "");
          //.replaceAll('.tpos.vn', '');
          ...
          context.read<ApplicationBloc>().add(ApplicationLoaded());
        }
      },
      child: Scaffold(
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          ...
                          urlLauch(
                              'https://tpos.vn/mobile/dang-ky-dung-thu.html');
                        },
                      ),
                    ),
                ],
              ...
              builder: (a, setState) => Stack(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    validator: (text) {
                      if (text.isEmpty) {
                        return S.current.homePage_domainNameCannotBeEmpty;
                      }
                      return null;
                    },
