...
class _AllMenuState extends State<AllMenu> with TickerProviderStateMixin {
  ...
  void _refreshMenu() {
    ...
    for (var group in homeMenuConfig.menuGroups) {
      final type = group.menuGroupType;
      final _AllMenuGroupModel model =
          _AllMenuGroupModel(group: type, items: <MenuItem>[]);
            ...
            children: [
              TabBar(
                  ...
                  tabs: _menuGroups.map((e) {
                    final tabColor = tabIndex == _menuGroups.indexOf(e)
                        ? e.group.backgroundColor
                        : const Color(0xffF2F3F4);

                    final textColor = tabIndex == _menuGroups.indexOf(e)
                        ? e.group.textColor
    ...
    return Container(
      child: LayoutBuilder(
        builder: (context, cs) {
          ...
          final itemSize = cs.maxWidth / columnCount - 10;
          return Wrap(
            runSpacing: 10,
            spacing: 10,
            children: items
