          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                labelText: '${S.current.homePage_maximumNumberOfLines}:',
                hintText: S.current.homePage_select0ToShowAll,
              ),
            ),
          ],
        ),
      ...
      child: Row(
        children: <Widget>[
          ...
          if (_menuType == MenuType.custom)
            _MenuOptionButton(
              title: _reorderEnable ? S.current.sortingDone : S.current.sort,
          ...
          children: group.children.map((menuRoute) {
            ...
            if (menu != null) {
              ...
              return NormalMenuItem(
                ...
                icon: menu.icon,
                iconColor: menu.type.backgroundColor,
      ...
      if (_canReorder)
        Padding(
          ...
          child: RaisedButton(
            ...
            // Thêm nhóm mới
            child: Text(S.current.homePage_addNewGroup),
            onPressed: () {
