...
void _setupTPosApiService() {
  ...
  GetIt.instance.registerFactory<AuthenticationApi>(() => AuthenticationApiImpl());
  GetIt.instance.registerFactory<CommonApi>(() => CommonApiImpl());
  GetIt.instance.registerFactory<PartnerExtApi>(() => PartnerExtApiImpl());
  GetIt.instance.registerFactory<ProductAttributeApi>(() => ProductAttributeApiImpl());
  GetIt.instance.registerFactory<ProductAttributeValueApi>(() => ProductAttributeValueApiImpl());
  GetIt.instance.registerFactory<StockMoveApi>(() => StockMoveApiImpl());
  GetIt.instance.registerFactory<ProductCategoryApi>(() => ProductCategoryApiImpl());
  GetIt.instance.registerFactory<ApplicationUserApi>(() => ApplicationUserApiImpl());
  GetIt.instance.registerFactory<NotificationApi>(() => NotificationApiImpl());
  GetIt.instance.registerFactory<SaleOnlineOrderApi>(() => SaleOnlineOrderApiImpl());
  GetIt.instance.registerFactory<ReportOrderApi>(() => ReportOrderApiImpl());
  GetIt.instance.registerFactory<OriginCountryApi>(() => OriginCountryApiImpl());
  GetIt.instance.registerFactory<ReportDeliveryOrderApi>(() => ReportDeliveryOrderApiImpl());
  GetIt.instance.registerFactory<ChangePasswordApi>(() => ChangePasswordApiImpl());
  ...
  GetIt.instance.registerFactory<ProductVariantApi>(() => ProductVariantApiImpl());
}
...
void _setupFacebookApiService() {
  ...
  GetIt.instance.registerFactory<ProductTemplateApi>(() => ProductTemplateApiImpl());
  GetIt.instance.registerFactory<ProductUomApi>(() => ProductUomApiImpl());
  GetIt.instance.registerFactory<ProductUomCategoryApi>(() => ProductUomCategoryApiImpl());
}
...
void _configService() {
  ...
  if (!kReleaseMode) {
    ...
    GetIt.instance<TPosApi>().dio.interceptors.add(
          LogInterceptor(
              requestHeader: true, requestBody: true, responseHeader: true, responseBody: true, request: true),
        );
  }
}
