...
import 'feature_group/account_payment/viewmodel/account_payment_type_list_viewmodel.dart';
import 'feature_group/account_payment/viewmodel/partner_search_contact_viewmodel.dart';
...
@Deprecated(
    'Locator is deprecated from version 1.8.0. Using GetIt.I<Service> instead')
TmtFlutterLocator locator = TmtFlutterLocator.instance;

@Deprecated(
    'Locator is deprecated from version 1.8.0. Using GetIt.I<Service> instead')
Future<void> setupLocator() async {
  final Logger _log = Logger("setupLocator");
  locator.allowReassignment = true;
  _log.info("set up Locator");

  /* set up Locator*/
  /// Register app setting service
  locator.registerLazySingleton<ISettingService>(() => AppSettingService());
  ...
  if (!App.isAppLogOut) {
    ...
    locator.registerLazySingleton<IReportService>(() => ReportService());
  }

  /// Register TPOS API Client Base
  locator.registerLazySingleton<TposApiClient>(() => TposApiClient());

  /// Register tpos api client service
  locator.registerLazySingleton<ITposApiService>(() => TposApiService());
  ...
  locator.registerFactory<PartnerSearchContactViewModel>(
  ...
  locator.registerFactory<AccountPaymentTypeListViewModel>(
  ...
  locator.registerFactory<TagListViewModel>(() => TagListViewModel());
  ...
  locator.registerLazySingleton<category_product_search.ProductSearchViewModel>(
      () => category_product_search.ProductSearchViewModel());
