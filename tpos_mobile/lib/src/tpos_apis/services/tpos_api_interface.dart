...
abstract class ITposApiService {
  ...
  Future<List<SaleOnlineOrder>> getSaleOnlineOrdersFilter(
      {int take, int skip, OldOdataFilter filter, OldOdataSortItem sort});
  ...
  Future<List<ProductAttribute>> getProductAttribute(int productId);
...
/* ASHIP API*/
  ...
  Future<List<ProductAttributeValue>> getProductAttributeSearch();

  Future<List<ProductAttributeValue>> getProductAttributeValueSearch();
