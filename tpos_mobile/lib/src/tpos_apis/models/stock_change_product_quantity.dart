...
class StockChangeProductQuantity {
  ...
  StockChangeProductQuantity.fromJson(Map<String, dynamic> json) {
    ...
    productTmpl = json['ProductTmpl'] != null
        ? ProductTemplate.fromJson(json['ProductTmpl'])
        : null;
    product =
        json['Product'] != null ? Product.fromJson(json['Product']) : null;
    location = json['Location'] != null
        ? StockLocation.fromJson(json['Location'])
        : null;

    productionLot =
        json['Lot'] != null ? StockProductionLot.fromJson(json['Lot']) : null;
  }
  ...
  Map<String, dynamic> toJson([bool removeIfNull = false]) {
    ...
    if (productionLot != null) {
      data['Lot'] = productionLot.toJson(removeIfNull: removeIfNull);
    }
