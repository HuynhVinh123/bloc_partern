...
class App {
  ...
  static GlobalKey<NavigatorState> navigatorKey = Get.key;
  ...
  static Future showDialog<T>(Widget widget,
      {BuildContext context, bool barrierDismissible = true, bool useRootNavigator = true}) async {
  ...
  static Future<bool> showConfirm(
      {String title, String content, BuildContext context, bool useRootNavigator = true}) async {
  ...
  static Future showToast(
    ...
    return await Flushbar(
      ...
      margin: EdgeInsets.only(left: 12, top: 12, right: 12, bottom: paddingBottom),
