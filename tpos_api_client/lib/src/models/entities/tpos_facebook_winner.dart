...
class TposFacebookWinner {
  TposFacebookWinner(
      {this.facebookPostId, this.facebookASUId, this.facebookUId, this.facebookName, this.dateCreated, this.totalDays});

  factory TposFacebookWinner.fromJson(Map<String, dynamic> jsonMap) {
    return TposFacebookWinner(
  ...
  Map<String, dynamic> toJson({bool removeIfNull = true}) {
    final data = {
      ...
      "TotalDays": totalDays,
      "DateCreated": dateCreated != null ? DateFormat("yyyy-MM-ddTHH:mm:ss'+07:00'").format(dateCreated) : null,
    };
    if (removeIfNull) {
