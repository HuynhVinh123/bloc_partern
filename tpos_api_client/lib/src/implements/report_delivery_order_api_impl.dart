...
class ReportDeliveryOrderApiImpl implements ReportDeliveryOrderApi {
  ...
  Future<DeliveryOrderReport> getReportDeliveryFastSaleOrder({
    ...
    final String body = json.encode(map);
  ...
  Future<SumDeliveryReportFastSaleOrder> getSumReportDeliveryFastSaleOrder(
    ...
    final response = await _apiClient
        .httpPost("/FastSaleOrder/SumDeliveryReport", data: json.encode(map));
  ...
  Future<List<ReportDeliveryOrderDetail>> getInvoicesDeliveryReportCustomer(
    ...
    if (cityCode != null) {
      map["CityCode"] = shipState;
    }

    final response = await _apiClient.httpGet(
        "/odata/FastSaleOrder/ODataService.GetDetailDeliveryReportCustomer",
        parameters: map);
