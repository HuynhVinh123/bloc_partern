...
abstract class ConversationApi {
  ...
  Future<List<Product>> getProductsByPageFacebook(
      {String keyword, int limit, int skip, String facebookId});
  ...
  Future<OdataListResult<FastSaleOrder>> getFastSaleOrders({int partnerId});
  Future<GetListConversationResult> getNotes(
      {String pageId, String facebookId});
  Future<Conversation> insertNote(String message, String pageId, String psid);
