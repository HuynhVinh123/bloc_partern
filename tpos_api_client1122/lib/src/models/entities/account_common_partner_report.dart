class AccountCommonPartnerReport {
  ...
  AccountCommonPartnerReport.fromJson(Map<String, dynamic> json) {
    ...
    if (json['DateFrom'] != null) {
      dateFrom = DateTime.fromMicrosecondsSinceEpoch(int.parse(json['DateFrom']
          .toString()
          .substring(6, json['DateFrom'].toString().length - 2)));
    }
    if (json['DateTo'] != null) {
      dateTo = DateTime.fromMicrosecondsSinceEpoch(int.parse(json['DateTo']
          .toString()
    ...
    if (json['DateInvoice'] != null) {
      dateInvoice = DateTime.fromMicrosecondsSinceEpoch(int.parse(
          json['DateInvoice']
              .toString()
