...
// private lateinit var srsFlvMuxer1: SrsFlvMuxer
...
//
// fun quantity(){
// srsFlvMuxers = ArrayList<SrsFlvMuxer>(2)
// for(i:Int in 0..1){
// srsFlvMuxers[i] = SrsFlvMuxer(this)
// }
// }
//
// /**
...
// srsFlvMuxer1.setVideoResolution(videoEncoder!!.height, videoEncoder!!.width)
// } else {
// srsFlvMuxer.setVideoResolution(videoEncoder!!.width, videoEncoder!!.height)
// srsFlvMuxer1.setVideoResolution(videoEncoder!!.width, videoEncoder!!.height)
// }
// srsFlvMuxer.start(url)
// //second url stream. For now hardcoded, modify this method to set in startStream library method.
// srsFlvMuxer1.start("rtmps://live-api-s.facebook.com:443/rtmp/103841385062906?s_bl=1&s_ps=1&s_psm=1&s_sw=0&s_vt=api-s&a=AbzuN1WXd-sqQQEc");
// }
//
...
// srsFlvMuxer1.setVideoResolution(videoEncoder!!.height, videoEncoder!!.width)
// for(i:Int in 0..1){
// srsFlvMuxers[i].setVideoResolution(videoEncoder!!.height, videoEncoder!!.width)
// }
// } else {
// srsFlvMuxer.setVideoResolution(videoEncoder!!.width, videoEncoder!!.height)
// srsFlvMuxer1.setVideoResolution(videoEncoder!!.width, videoEncoder!!.height)
// for(i:Int in 0..1){
// srsFlvMuxers[i].setVideoResolution(videoEncoder!!.width, videoEncoder!!.height)
// }
// }
// if(urls!= null){
// //            srsFlvMuxer.start(urls[0])
// //            srsFlvMuxer1.start(urls[1])
// var index:Int = 0
// for(url:String in urls){
// srsFlvMuxers[index].start(url)
// index++
// }
//
// }
...
// return srsFlvMuxer1.shouldRetry(reason)
// }
//
...
// for(i:Int in 0..1){
// srsFlvMuxers[i].reConnect(delay)
// }
// }
//
// /**
...
// srsFlvMuxer.setSpsPPs(sps.duplicate(), pps)
// srsFlvMuxer1.setSpsPPs(sps.duplicate(), pps)
// for(i:Int in 0..1){
...
// srsFlvMuxer1.sendVideo(h264Buffer.duplicate(), info)
// for(i:Int in 0..1){
